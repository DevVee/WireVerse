var He=Object.defineProperty;var Be=(f,t,e)=>t in f?He(f,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):f[t]=e;var le=(f,t,e)=>Be(f,typeof t!="symbol"?t+"":t,e);import{W as _t,A as Bt,D as U,M as g,a as p,B as y,P as kt,C as T,S as gt,b as ft,T as $,c as te,d as ge,e as Ne,f as At,g as X,R as ee,V as m,h as Nt,i as Wt,j as mt,k as A,F as $t,l as xt,m as Dt,n as Ot,G as O,o as ct,p as ut,q as dt,r as J,s as Oe,t as Re,u as me,v as We,w as $e,x as Yt,y as se,z as ze,E as _e,H as we,I as De,J as Fe,L as je,K as Ge,N as Ye}from"./three-CDtFgZcL.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=e(o);fetch(o.href,i)}})();class Xe{constructor(){this._state=null,this._payload=null,this._listeners={}}get state(){return this._state}get payload(){return this._payload}setState(t,e=null){const s=this._state;this._state=t,this._payload=e,this._emit("stateChange",{from:s,to:t,payload:e})}on(t,e){return this._listeners[t]||(this._listeners[t]=[]),this._listeners[t].push(e),()=>this.off(t,e)}off(t,e){this._listeners[t]&&(this._listeners[t]=this._listeners[t].filter(s=>s!==e))}_emit(t,e){const s=this._listeners[t];if(s)for(const o of s)o(e)}}class Ve{constructor(){this._callbacks=[],this._running=!1,this._raf=null,this._lastTime=0,this._tick=this._tick.bind(this)}add(t){this._callbacks.push(t)}remove(t){this._callbacks=this._callbacks.filter(e=>e!==t)}start(){this._running||(this._running=!0,this._lastTime=performance.now(),this._raf=requestAnimationFrame(this._tick))}stop(){this._running=!1,this._raf&&(cancelAnimationFrame(this._raf),this._raf=null)}_tick(t){if(!this._running)return;const e=Math.min((t-this._lastTime)/1e3,.1);this._lastTime=t;for(const s of this._callbacks)s(e,t);this._raf=requestAnimationFrame(this._tick)}}class Ue{constructor(){this.canvas=null,this._renderer=null}init(){this.canvas=document.getElementById("game-canvas"),this._renderer=new _t({canvas:this.canvas,antialias:!1,powerPreference:"high-performance",alpha:!1,stencil:!1,depth:!0}),this._renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this._renderer.setSize(window.innerWidth,window.innerHeight),this._renderer.shadowMap.enabled=!1,window.addEventListener("resize",()=>this._onResize()),this.hide()}show(){this.canvas.style.display="block"}hide(){this.canvas.style.display="none"}get instance(){return this._renderer}_onResize(){this._renderer.setSize(window.innerWidth,window.innerHeight)}}class Ke{constructor(){this._touches=new Map,this._listeners={}}init(){document.addEventListener("touchstart",t=>this._onTouchStart(t),{passive:!0}),document.addEventListener("touchend",t=>this._onTouchEnd(t),{passive:!0}),document.addEventListener("touchmove",t=>this._onTouchMove(t),{passive:!0})}on(t,e){return this._listeners[t]||(this._listeners[t]=[]),this._listeners[t].push(e),()=>this.off(t,e)}off(t,e){this._listeners[t]&&(this._listeners[t]=this._listeners[t].filter(s=>s!==e))}_onTouchStart(t){for(const e of t.changedTouches)this._touches.set(e.identifier,{x:e.clientX,y:e.clientY});this._emit("touchstart",t)}_onTouchMove(t){this._emit("touchmove",t)}_onTouchEnd(t){for(const e of t.changedTouches)this._touches.delete(e.identifier);this._emit("touchend",t)}_emit(t,e){const s=this._listeners[t];if(s)for(const o of s)o(e)}get activeTouches(){return this._touches}}class Qe{constructor(t){this.state=t,this._timer=null,this.container=this._build()}_build(){const t=document.createElement("div");return t.className="screen screen-hidden splash-screen",t.innerHTML=`
    ...
    `,t}onShow(){const t=Te[Math.floor(Math.random()*Te.length)];this.container.querySelector("#ld-tip").textContent="TIP: "+t,this._run()}_run(){const t=this.container.querySelector("#ld-fill"),e=this.container.querySelector("#ld-pct");let s=0,o=0;const i=()=>{const a=Math.random()*14+6;if(s=Math.min(s+a,100),o+=140,t.style.width=`${s}%`,e.textContent=`${Math.floor(s)}%`,s>=100&&o>=1e3){setTimeout(()=>{L.isFirstLaunch()?this.state.setState("nameEntry"):(L.checkLoginStreak(),this.state.setState("menu"))},350);return}setTimeout(i,140+Math.random()*60)};i()}}const st=(f,t=18,e=18)=>`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${f}</svg>`,F={settings:st('<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>'),achievements:st('<path d="M7 21h10M12 21v-4"/><path d="M17 5H7v8a5 5 0 0 0 10 0V5z"/><path d="M7 5H4v5h3M17 5h3v5h-3"/>'),tools:st('<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>'),credits:st('<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><circle cx="12" cy="8" r="0.5" fill="currentColor"/>'),exit:st('<path d="M18.36 6.64a9 9 0 1 1-12.73 0"/><line x1="12" y1="2" x2="12" y2="12"/>'),learn:st('<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>'),back:st('<line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/>'),audio:st('<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/>'),pause:st('<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>'),hint:st('<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>'),user:st('<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>'),check:st('<polyline points="20 6 9 17 4 12"/>')};function Pe(f=""){return`<div class="wv-logo" ${f?`style="font-size:${f}"`:""}>WIRE<span class="wv-bolt"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 18" width="0.55em" height="0.9em"><polygon points="7,0 0,10 6,10 3,18 10,8 4,8" fill="#ffa500"/></svg></span>VERSE</div>`}class Je{constructor(t){this.state=t,this.container=this._build(),this._input=this.container.querySelector("#ne-input")}_build(){const t=document.createElement("div");t.className="screen screen-hidden name-entry-screen",t.innerHTML=`
      <div class="ne-bg-grid"></div>
      <div class="ne-content">

        ${Pe("clamp(42px, 11vw, 64px)")}
    ...
    `;const e=t.querySelector("#ne-start"),s=t.querySelector("#ne-input"),o=()=>{const i=s.value.trim();if(!i){s.classList.add("ne-input--shake"),setTimeout(()=>s.classList.remove("ne-input--shake"),500);return}L.setPlayerName(i),L.checkLoginStreak(),this.state.setState("menu")};return e.addEventListener("click",o),s.addEventListener("keydown",i=>{i.key==="Enter"&&o()}),t}onShow(){setTimeout(()=>{var t;return(t=this._input)==null?void 0:t.focus()},350)}}const ts=[{id:"learn",label:"LEARN",icon:F.learn,state:"stagesHub",primary:!0},{id:"settings",label:"SETTINGS",icon:F.settings,state:"settings"},{id:"achievements",label:"ACHIEVEMENTS",icon:F.achievements,state:"achievements"},{id:"tools",label:"TOOLS",icon:F.tools,state:"tools"},{id:"credits",label:"CREDITS",icon:F.credits,state:"credits"},{id:"exit",label:"EXIT",icon:F.exit,state:"exit",danger:!0}];class es{constructor(t){this.state=t,this.container=this._build()}_build(){const t=ts.map(s=>`
      <button
    ...
    `,e.querySelectorAll(".mm-btn").forEach(s=>{s.addEventListener("click",()=>{var i,a,n,r;const o=s.dataset.state;if(o==="exit"){(r=(n=(a=(i=window.Capacitor)==null?void 0:i.Plugins)==null?void 0:a.App)==null?void 0:n.exitApp)==null||r.call(n);return}this.state.setState(o)})}),this._el=e,e}onShow(){const t=L.load(),e=L.getStats(),s=t.playerName||"Player",o=Math.round(e.xpInLevel/e.xpToNext*100),i=L.getExploreProgress(),a=i.outletCount,n=i.switchCount;this._el.querySelector("#mm-player-badge").innerHTML=`
      <span class="mm-player-icon">${F.user}</span>
    ...
    `}}let nt=null,Rt=null,pt=null,It=null,Tt=null,Ht=null,Vt=0,Se=!1;function de(){return nt||(nt=new(window.AudioContext||window.webkitAudioContext),It=nt.createGain(),Tt=nt.createGain(),Ht=nt.createGain(),Tt.connect(It),Ht.connect(It),It.connect(nt.destination),qe()),nt}function qe(){const f=L.load().settings||{},t=(f.masterVolume??80)/100,e=(f.sfx??90)/100,s=(f.music??70)/100;It&&(It.gain.value=t),Tt&&(Tt.gain.value=e),Ht&&(Ht.gain.value=s)}function Ut(f,t,e,s=.18){const o=f.sampleRate*t,i=f.createBuffer(1,o,f.sampleRate),a=i.getChannelData(0);for(let c=0;c<o;c++)a[c]=Math.random()*2-1;const n=f.createBufferSource();n.buffer=i;const r=f.createBiquadFilter();r.type="bandpass",r.frequency.value=e,r.Q.value=.8;const l=f.createGain();l.gain.setValueAtTime(s,f.currentTime),l.gain.exponentialRampToValueAtTime(1e-4,f.currentTime+t),n.connect(r),r.connect(l),l.connect(Tt),n.start(),n.stop(f.currentTime+t)}function yt(f,t,e,s="sine",o=.25,i=.01,a=null){const n=f.createOscillator(),r=f.createGain();n.type=s,n.frequency.value=t;const l=a??e*.6;return r.gain.setValueAtTime(0,f.currentTime),r.gain.linearRampToValueAtTime(o,f.currentTime+i),r.gain.setValueAtTime(o,f.currentTime+e-l),r.gain.exponentialRampToValueAtTime(1e-4,f.currentTime+e),n.connect(r),r.connect(Tt),n.start(),n.stop(f.currentTime+e),n}const V={init(){if(Se)return;Se=!0;const f=()=>{de(),nt.state==="suspended"&&nt.resume()};document.addEventListener("click",f,{once:!0}),document.addEventListener("touchstart",f,{once:!0,passive:!0}),document.addEventListener("keydown",f,{once:!0})},applySettings(){nt&&qe()},play(f,t){try{const e=de();switch(e.state==="suspended"&&e.resume(),f){case"footstep":{if(Vt=(Vt||0)+(t||.016),Vt<.38)return;Vt=0,Ut(e,.055,140+Math.random()*80,.12);break}case"door":{const s=e.createOscillator(),o=e.createGain();s.type="sawtooth",s.frequency.setValueAtTime(90,e.currentTime),s.frequency.exponentialRampToValueAtTime(30,e.currentTime+.55),o.gain.setValueAtTime(.18,e.currentTime),o.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.55),s.connect(o),o.connect(Tt),s.start(),s.stop(e.currentTime+.55),Ut(e,.18,3e3,.06);break}case"interact_click":{yt(e,800,.08,"square",.15,.005,.07);break}case"success":{[392,493.88,587.33].forEach((o,i)=>{setTimeout(()=>yt(e,o,.5,"sine",.18,.02,.35),i*80)});break}case"error":{yt(e,120,.22,"sawtooth",.2,.005,.18);break}case"xp_gain":{yt(e,1200,.14,"sine",.14,.01,.1),setTimeout(()=>yt(e,1600,.12,"sine",.1,.01,.09),80);break}case"breaker_click":{Ut(e,.025,2e3,.22),setTimeout(()=>Ut(e,.1,80,.28),20);break}case"complete":{[261.63,329.63,392,523.25].forEach((o,i)=>{setTimeout(()=>yt(e,o,.7,"sine",.2,.02,.5),i*110)}),setTimeout(()=>{[523.25,659.25,783.99].forEach(o=>yt(e,o,1.2,"sine",.18,.05,.9))},550);break}}}catch{}},startAmbient(){try{const f=de();if(Rt)return;const t=f.createOscillator();t.type="sine",t.frequency.value=60;const e=f.createOscillator();e.type="sine",e.frequency.value=120;const s=f.createBuffer(1,f.sampleRate*2,f.sampleRate),o=s.getChannelData(0);for(let c=0;c<o.length;c++)o[c]=Math.random()*2-1;const i=f.createBufferSource();i.buffer=s,i.loop=!0;const a=f.createBiquadFilter();a.type="lowpass",a.frequency.value=400,pt=f.createGain(),pt.gain.value=0;const n=f.createGain();n.gain.value=.055;const r=f.createGain();r.gain.value=.02;const l=f.createGain();l.gain.value=.03,t.connect(n),n.connect(pt),e.connect(r),r.connect(pt),i.connect(a),a.connect(l),l.connect(pt),pt.connect(Ht),t.start(),e.start(),i.start(),Rt={hum:t,hum2:e,fan:i},pt.gain.linearRampToValueAtTime(1,f.currentTime+2.5)}catch{}},stopAmbient(){try{if(!Rt||!nt)return;pt==null||pt.gain.linearRampToValueAtTime(0,nt.currentTime+1.2);const f=Rt;Rt=null,setTimeout(()=>{try{f.hum.stop(),f.hum2.stop(),f.fan.stop()}catch{}},1300)}catch{}}},ss=[{id:"profile",label:"PROFILE",icon:F.user},{id:"audio",label:"AUDIO",icon:F.audio}];class is{constructor(t){this.state=t,this._data={},this._activeTab="profile",this.container=this._build()}_build(){const t=document.createElement("div");return t.className="screen screen-hidden settings-screen",t.innerHTML=`
      <header class="game-header">
        <button class="hdr-back" id="stg-back">${F.back}</button>
    ...
    `,t.querySelector("#stg-save-name").addEventListener("click",()=>{const s=t.querySelector("#stg-name-input").value.trim();if(!s)return;L.setPlayerName(s);const o=t.querySelector("#stg-save-status");o.textContent="Name saved!",o.className="stg-save-status stg-save-status--ok",setTimeout(()=>{o.textContent="",o.className="stg-save-status"},2e3)})}_renderAudio(t){t.innerHTML=`
    ...
    `,t.querySelectorAll('.stg-row[data-type="slider"]').forEach(e=>{const s=e.querySelector(".stg-slider"),o=e.querySelector(".stg-val"),i=e.dataset.key;s.addEventListener("input",()=>{this._data[i]=Number(s.value),o.textContent=`${s.value}%`,L.saveSettings(this._data),V.applySettings()})}),t.querySelectorAll('.stg-row[data-type="toggle"]').forEach(e=>{const s=e.querySelector(".stg-toggle"),o=e.dataset.key;s.addEventListener("click",()=>{const i=!this._data[o];this._data[o]=i,s.className=`stg-toggle ${i?"stg-toggle--on":"stg-toggle--off"}`,s.textContent=i?"ON":"OFF",L.saveSettings(this._data),V.applySettings()})})}_sliderRow(t,e,s){return`
    ...
    `,t.querySelector("#ach-back").addEventListener("click",()=>this.state.setState("menu")),t.querySelector("#ach-tabs").addEventListener("click",e=>{const s=e.target.closest("[data-cat]");s&&(this._cat=s.dataset.cat,t.querySelectorAll(".ach-tab").forEach(o=>o.classList.toggle("ach-tab--active",o.dataset.cat===this._cat)),this._renderList(t))}),this._el=t,t}onShow(){const t=Ee(),e=t.filter(s=>s.progress>=s.goal).length;this._el.querySelector("#ach-stats").innerHTML=`<span class="hstat" style="color:#00d4ff;font-size:12px;letter-spacing:.08em;">${e}/${t.length} UNLOCKED</span>`,this._renderList(this._el)}_renderList(t){const e=(t||this._el).querySelector("#ach-list"),s=Ee(),o=this._cat==="ALL"?s:s.filter(i=>i.cat===this._cat.toLowerCase());e.innerHTML=o.map(i=>{const a=Math.min(100,Math.round(i.progress/i.goal*100)),n=i.progress>=i.goal,r=Me[i.cat.toUpperCase()]||"⚡";return`
      ...
      <div class="tl-view" id="tl-guide" style="display:none">
        <header class="game-header">
          <button class="hdr-back" id="tl-guide-back">${F.back}</button>
        ...
        <div class="tl-guide-body">
          ...
          <div class="tl-tasks-panel">
            ...
            <button class="tl-hint-btn">${F.hint} HINT <span class="tl-hint-badge">2</span></button>
          </div>
    ...
    `,t.querySelector("#tl-back").addEventListener("click",()=>this.state.setState("menu")),t.querySelector("#tl-guide-back").addEventListener("click",()=>this._goToBrowse()),t.querySelector("#tl-skip-btn").addEventListener("click",()=>this._goToBrowse()),t.querySelector("#tl-next-btn").addEventListener("click",()=>this._nextStep()),t.querySelector("#tl-dialog").addEventListener("click",e=>{e.target.closest(".tl-skip-btn")||this._nextStep()}),this._el=t,t}onShow(){this._goToBrowse()}_goToBrowse(){this._el.querySelector("#tl-browse").style.display="flex",this._el.querySelector("#tl-guide").style.display="none",this._renderBrowse()}_renderBrowse(){const t=this._el.querySelector("#tl-tool-list");t.innerHTML=Ce.map(e=>`
      <button class="tl-tool-card" data-id="${e.id}">
        ...
        <div class="tl-tc-arrow">${F.back}</div>
      </button>
...
`;function cs(){if(document.querySelector("#crd-css"))return;const f=document.createElement("style");f.id="crd-css",f.textContent=ls,document.head.appendChild(f)}class ds{constructor(t){this.state=t,this.container=this._build()}_build(){cs();const t=rs.map(s=>`
      <div class="crd-row">
...
`;function ps(){if(document.querySelector("#lh-css"))return;const f=document.createElement("style");f.id="lh-css",f.textContent=hs,document.head.appendChild(f)}class us{constructor(t){this.state=t,this.container=this._build()}_build(){ps();const t=document.createElement("div");return t.className="screen screen-hidden",t.innerHTML=`
      <div class="lh">
        <header class="lh-top">
      ...
      </div>`,t.querySelector(".lh-back").addEventListener("click",()=>this.state.setState("menu")),this._el=t,t}_renderCards(t){const e=he.filter(o=>!!t[o.id]).length;this._el.querySelector("#lh-badge").innerHTML=`
      <div>${e}/${he.length}</div>
      <div class="lh-badge-label">Completed</div>`;const s=this._el.querySelector("#lh-body");s.innerHTML=he.map((o,i)=>{const a=!!t[o.id],n=o.requires&&!t[o.requires],r=o.pills.map(([l,c,d])=>`
        <div class="lh-pill">
...
`;function bs(){if(document.querySelector("#wtl-css"))return;const f=document.createElement("style");f.id="wtl-css",f.textContent=ws,document.head.appendChild(f)}function _s(f,t){const e=f.width,s=e/2,o=e/2,i=f.getContext("2d");i.clearRect(0,0,e,e);const a=e*.46,n=e*.33,r=e*.18,l=(c,d,h)=>{if(h){const u=i.createRadialGradient(s,o,c*.4,s,o,c+18);u.addColorStop(0,d+"cc"),u.addColorStop(1,"transparent"),i.fillStyle=u,i.beginPath(),i.arc(s,o,c+18,0,Math.PI*2),i.fill()}};l(a,"#888",t===2),i.beginPath(),i.arc(s,o,a,0,Math.PI*2),i.fillStyle=t===2?"#888888":t===-1?"#555":"#3a3a3a",i.fill(),l(n,"#3355cc",t===1),i.beginPath(),i.arc(s,o,n,0,Math.PI*2),i.fillStyle=t===1?"#3355cc":t===-1?"#333":"#222255",i.fill(),l(r,"#b87333",t===0),i.beginPath(),i.arc(s,o,r,0,Math.PI*2),i.fillStyle=t===0?"#d4893a":t===-1?"#555":"#6b4420",i.fill(),[[a,"#ffffff22"],[n,"#ffffff18"],[r,"#ffffff25"]].forEach(([c,d])=>{i.beginPath(),i.arc(s,o,c,0,Math.PI*2),i.strokeStyle=d,i.lineWidth=1.5,i.stroke()})}function lt(f,t){const e=document.createElement("canvas");e.width=160,e.height=50;const s=e.getContext("2d");s.fillStyle="rgba(4,10,24,0.9)",s.beginPath(),s.roundRect(2,2,156,46,9),s.fill(),s.strokeStyle=f,s.lineWidth=2,s.beginPath(),s.roundRect(2,2,156,46,9),s.stroke(),s.fillStyle=f,s.font="bold 18px monospace",s.textAlign="center",s.textBaseline="middle",s.fillText(t,80,25);const o=new ft(e),i=new Oe({map:o,transparent:!0,depthTest:!1}),a=new Re(i);return a.scale.set(.85,.28,1),a}class xs{constructor(t){this.state=t,this._step=0,this._three=null,this._animId=null,this._sceneObjs=[],this._sparks=[],this._dropObjs=[],this._fireObjs=[],this._quizDone=!1,this._cqIdx=0,this._cqCorrect=0,this._cqTargets=[],this._cqActive=!1,this._cqTargetId="",this._quizMeshTap=null,this._camPos=new m(4,3,8),this._camTarget=new m(0,0,0),this.container=this._build()}_build(){bs();const t=document.createElement("div");return t.className="screen screen-hidden",t.innerHTML=`
      <div class="wtl">
        <header class="wtl-top">
          ...
          <span class="wtl-ch-step" id="wtl-step-num">1/${rt.length}</span>
        </header>
      ...
      </div>`,t.querySelector(".wtl-back").addEventListener("click",()=>this.state.setState("stagesHub")),t.querySelector("#wtl-next").addEventListener("click",()=>this._onNext()),t.querySelector("#wtl-prev").addEventListener("click",()=>this._onPrev()),t.querySelector("#wtl-bubble-tap").addEventListener("click",()=>this._onNext()),this._el=t,t}_initThree(){if(this._three)return;const t=this._el.querySelector("#wtl-canvas"),e=this._el.querySelector("#wtl-scene"),s=e.offsetWidth,o=e.offsetHeight;if(!s||!o){setTimeout(()=>this._initThree(),60);return}const i=new _t({canvas:t,antialias:!0,powerPreference:"high-performance"});i.setPixelRatio(Math.min(devicePixelRatio,2)),i.setSize(s,o),i.shadowMap.enabled=!0,i.shadowMap.type=Nt,i.toneMapping=Wt,i.toneMappingExposure=1.15;const a=new mt;a.background=new A(658968),a.fog=new $t(658968,.025);const n=new xt(52,s/o,.1,80);n.position.copy(this._camPos),n.lookAt(this._camTarget),oe(a);const{lampFill:r}=ie(a,{benchY:-.64,benchW:11,benchD:5.5}),l=r,c=new Dt,d=new Ot,h=w=>{if(!this._cqActive&&!this._quizMeshTap)return;w.preventDefault();const b=t.getBoundingClientRect(),_=w.touches?w.changedTouches[0]:w;d.x=(_.clientX-b.left)/b.width*2-1,d.y=-((_.clientY-b.top)/b.height)*2+1,c.setFromCamera(d,n);const v=c.intersectObjects(this._cqTargets);if(v.length){const S=v[0].object.userData.wireId;this._cqActive&&this._onColorTap(S,v[0].point),this._quizMeshTap&&this._quizMeshTap(S)}};t.addEventListener("pointerdown",h),this._resizeObs=new ResizeObserver(()=>{const w=e.offsetWidth,b=e.offsetHeight;!w||!b||(i.setSize(w,b),n.aspect=w/b,n.updateProjectionMatrix())}),this._resizeObs.observe(e),this._three={renderer:i,scene:a,camera:n,lamp:l},this._cqActive=!1,this._quizMeshTap=null;const u=()=>{this._animId=requestAnimationFrame(u),this._updateThree(),i.render(a,n)};u()}_clearSceneObjs(){if(this._three){for(const t of this._sceneObjs)this._three.scene.remove(t);this._sceneObjs=[],this._dropObjs=[],this._fireObjs=[],this._cqTargets=[],this._cqActive=!1,this._quizMeshTap=null,this._el.querySelector("#wtl-scene").classList.remove("fire-anim"),this._el.querySelector("#wtl-cross-overlay").classList.remove("show"),this._el.querySelector("#wtl-wt-badge").classList.remove("show"),this._el.querySelector("#wtl-cquiz-prompt").classList.remove("show"),this._el.querySelector("#wtl-tap-hint").style.display="none"}}_add(t){return this._three.scene.add(t),this._sceneObjs.push(t),t}_makeWire(t,e){const s=t.shape==="armored",o=t.shape==="flat",i=new g({color:t.col,roughness:s?.18:o?.75:.35,metalness:s?.92:.05,clearcoat:s?0:.6,clearcoatRoughness:.2}),a=new p(this._makeWireGeo(t),i);if(a.rotation.z=Math.PI/2,a.castShadow=!0,a.userData.wireId=t.id,a.position.set(e,-.35,0),o){const n=new O;[-.04,0,.04].forEach((r,l)=>{const c=[1118481,12088115,15658734][l],d=new g({color:c,roughness:.4,metalness:l===1?.9:0}),h=new p(new T(.035,.035,5.85,12),d);h.position.set(0,0,r),n.add(h)}),a.add(n)}return s&&this._makeArmorSpiral(a,t.r),a}_makeWireGeo(t){return t.shape==="flat"?new ct(t.r*.45,5.6,8,16):new T(t.r,t.r,5.8,24)}_makeArmorSpiral(t,e){const s=new g({color:11184810,roughness:.18,metalness:.92}),o=[],i=45,a=5.6;for(let c=0;c<=200;c++){const d=c/200,h=d*Math.PI*2*i,u=-a/2+d*a;o.push(new m(Math.cos(h)*e,u,Math.sin(h)*e))}const n=new ut(o),r=new dt(n,200,.022,8,!1),l=new p(r,s);t.add(l)}_makeCopperEnd(t,e,s=!1){const o=new O,i=new g({color:13928762,roughness:.15,metalness:.95,emissive:13928762,emissiveIntensity:.12});if(s)for(let a=0;a<7;a++){const n=a/7*Math.PI*2,r=new p(new T(.018,.018,.14,8),i);r.rotation.z=Math.PI/2,r.position.set(0,Math.cos(n)*.038,Math.sin(n)*.038),o.add(r)}else{const a=new p(new T(.065,.065,.14,16),i);a.rotation.z=Math.PI/2,o.add(a)}return o.position.set(t,-.35,e),o}_makeTermEnd(t,e,s){const o=new g({color:11184810,roughness:.12,metalness:.95}),i=new p(new T(s+.02,s+.02,.16,16),o);return i.rotation.z=Math.PI/2,i.position.set(t,-.35,e),i}_applyScene(t){this._clearSceneObjs();const e=t.scene;if(e!=="empty"){if(e==="wire_drop"||e==="wire_single"){const s={col:1710638,r:.13,shape:"round",id:"anatomy"},o=this._makeWire(s,0);e==="wire_drop"?(o.position.set(0,4,0),this._dropObjs.push({mesh:o,target:-.35,vel:0})):o.position.set(0,-.35,0),this._add(o),this._add(this._makeCopperEnd(-3.01,0,!0)),this._add(this._makeCopperEnd(3.01,0,!0)),this._add(this._makeTermEnd(-2.9,0,.13)),this._add(this._makeTermEnd(2.9,0,.13))}if(e==="cross_section"){this._el.querySelector("#wtl-cross-overlay").classList.add("show");const o=this._el.querySelector("#wtl-cross-canvas");_s(o,t.layer??-1);const i=this._el.querySelector("#wtl-cross-labels"),a=[{name:"COPPER",hex:"#b87333",active:t.layer===0},{name:"INSULATION",hex:"#3355cc",active:t.layer===1},{name:"JACKET",hex:"#666666",active:t.layer===2}];i.innerHTML=a.map(n=>`
        <span class="wtl-cross-tag" style="color:${n.active?n.hex:"rgba(255,255,255,0.3)"};border-color:${n.active?n.hex:"rgba(255,255,255,0.12)"};font-weight:${n.active?"800":"400"}">
          ${n.name}
        </span>`).join("")}if(e==="color_wires"&&(this._cqTargets=[],pe.forEach(s=>{const o=this._makeWire({col:s.col,r:.14,shape:"round",id:s.id},0);o.position.z=s.z,this._add(o),this._cqTargets.push(o),this._add(this._makeCopperEnd(-2.71,s.z,!1)),this._add(this._makeCopperEnd(2.71,s.z,!1)),this._add(this._makeTermEnd(-2.7,s.z,.14)),this._add(this._makeTermEnd(2.7,s.z,.14));const i=lt(s.hex,s.lbl);i.position.set(0,.1,s.z),this._add(i);const a=t.focus;a&&a!==s.id&&(o.material.opacity=.2,o.material.transparent=!0),a===s.id&&(o.material.emissive=new A(s.col),o.material.emissiveIntensity=.25)})),e==="wt_slots"){const s=new g({color:662058,roughness:.9,transparent:!0,opacity:.6});Kt.forEach((o,i)=>{const a=(i-2)*1.1,n=new p(new T(.23,.23,5.6,24),s);n.rotation.z=Math.PI/2,n.position.set(a,-.35,0),this._add(n);const r=lt("#334455",o.lbl);r.position.set(a,.12,0),this._add(r)})}if(e==="wt_show"){const s=t.active??-1;Kt.forEach((o,i)=>{const a=(i-2)*1.1,n=i===s;let r;if(o.shape==="armored"){r=new O;const l=new p(new T(o.r,o.r,5.8,20),new g({color:5592405,roughness:.5,metalness:.6}));r.add(l),this._makeArmorRings(r,o.r,n?24:14),r.rotation.z=Math.PI/2,r.position.set(a,-.35,0),r.castShadow=!0,l.userData.wireId=o.id,this._cqTargets.push(l),this._add(r)}else{const l=new T(o.r,o.r,5.8,24),c=new g({color:o.col,roughness:.65,metalness:.05,transparent:!n,opacity:n?1:.22}),d=new p(l,c);d.rotation.z=Math.PI/2,d.position.set(a,-.35,0),d.castShadow=!0,d.userData.wireId=o.id,this._add(d),n&&(c.emissive=new A(o.col),c.emissiveIntensity=.2)}if(n){const l=lt(o.hex,o.lbl);l.position.set(a,.18,0),this._add(l);const c=this._el.querySelector("#wtl-wt-badge");this._el.querySelector("#wtl-wt-name").textContent=o.lbl,this._el.querySelector("#wtl-wt-tag").textContent=o.tag,c.classList.add("show")}this._add(this._makeCopperEnd(a-2.91,0)),this._add(this._makeCopperEnd(a+2.91,0)),this._add(this._makeTermEnd(a-2.9,0,o.r)),this._add(this._makeTermEnd(a+2.9,0,o.r))})}if(e==="awg_pair"){const s=t.hl;[{id:"awg14",r:.11,col:8934826,hex:"#8855aa",x:-1.1,lbl:"AWG 14"},{id:"awg12",r:.155,col:13395456,hex:"#cc6600",x:1.1,lbl:"AWG 12"}].forEach(i=>{const a=s===i.id||!s,n=new g({color:i.col,roughness:.6,metalness:.05,transparent:!a,opacity:a?1:.25}),r=new p(new T(i.r,i.r,5.4,22),n);r.rotation.z=Math.PI/2,r.position.set(i.x,-.35,0),r.castShadow=!0,a&&(n.emissive=new A(i.col),n.emissiveIntensity=s?.25:0),this._add(r);const l=lt(i.hex,i.lbl);l.position.set(i.x,.12,0),this._add(l),this._add(this._makeCopperEnd(i.x-2.71,0)),this._add(this._makeCopperEnd(i.x+2.71,0))})}if(e==="awg_fire"){const s=new g({color:8934826,roughness:.6,metalness:.05}),o=new p(new T(.11,.11,5.4,22),s);o.rotation.z=Math.PI/2,o.position.set(0,-.35,0),o.castShadow=!0,this._add(o),this._fireObjs.push({mesh:o,mat:s,t:0}),this._el.querySelector("#wtl-scene").classList.add("fire-anim");const i=lt("#ff4400","AWG 14");i.position.set(0,.12,0),this._add(i)}if(e!=="bench_clean"&&(e==="wt_all"&&Kt.forEach((s,o)=>{const i=(o-2)*1.25,a=new g({color:s.col,roughness:.65,metalness:s.shape==="armored"?.7:.05}),n=new p(new T(s.r,s.r,5.4,22),a);n.rotation.z=Math.PI/2,n.position.set(i,-.35,0),n.castShadow=!0,this._add(n);const r=lt(s.hex,s.lbl);r.position.set(i,.12,0),this._add(r),a.emissive=new A(s.col),a.emissiveIntensity=.15}),e==="quiz"||e==="quiz_intro")){const s=t.qi;if(s==null)return;const i=Zt[s].vis;let a=Kt.find(r=>r.id.toLowerCase()===i),n=pe.find(r=>r.id===i);if(i==="awg"){const r=new g({color:13395456,roughness:.6,metalness:0}),l=new p(new T(.155,.155,5.4,22),r);l.rotation.z=Math.PI/2,l.position.set(0,-.35,0),l.castShadow=!0,this._add(l);const c=lt("#cc6600","AWG 12");c.position.set(0,.12,0),this._add(c)}else if(a){const r=new g({color:a.col,roughness:.65,metalness:a.shape==="armored"?.7:.05}),l=new p(new T(a.r,a.r,5.4,22),r);if(l.rotation.z=Math.PI/2,l.position.set(0,-.35,0),l.castShadow=!0,a.shape==="armored"){const d=new O;d.add(l),this._makeArmorRings(d,a.r,22),d.rotation.z=Math.PI/2,d.children[0].rotation.z=0,d.position.set(0,-.35,0),this._add(d)}else r.emissive=new A(a.col),r.emissiveIntensity=.15,this._add(l);const c=lt(a.hex,a.lbl);c.position.set(0,.18,0),this._add(c)}else if(n){const r=new g({color:n.col,roughness:.6,metalness:.05}),l=new p(new T(.14,.14,5.4,24),r);l.rotation.z=Math.PI/2,l.position.set(0,-.35,0),l.castShadow=!0,r.emissive=new A(n.col),r.emissiveIntensity=.2,this._add(l);const c=lt(n.hex,n.lbl);c.position.set(0,.12,0),this._add(c)}else if(i==="outdoor"){const r=new g({color:5075008,roughness:.7,metalness:0}),l=new p(new T(.22,.22,5.4,22),r);l.rotation.z=Math.PI/2,l.position.set(0,-.35,0),l.castShadow=!0,r.emissive=new A(5075008),r.emissiveIntensity=.2,this._add(l);const c=lt("#4d7040","UF-B");c.position.set(0,.12,0),this._add(c)}else if(i==="neutral"){const r=new g({color:14211288,roughness:.6,metalness:.05}),l=new p(new T(.14,.14,5.4,24),r);l.rotation.z=Math.PI/2,l.position.set(0,-.35,0),l.castShadow=!0,this._add(l);const c=lt("#d8d8d8","WHITE");c.position.set(0,.12,0),this._add(c)}}}}_updateThree(){if(!this._three)return;const{camera:t,lamp:e}=this._three,s=performance.now()*.001,o=rt[this._step],i=o.cam,a=new m(...i.p),n=new m(...i.t);this._camPos.lerp(a,.042),this._camTarget.lerp(n,.042),t.position.copy(this._camPos),t.lookAt(this._camTarget),e.intensity=1.5+Math.sin(s*4.1)*.07;for(const r of this._dropObjs){const l=r.mesh.position.y-r.target;Math.abs(l)<.01&&Math.abs(r.vel)<.002?r.mesh.position.y=r.target:(r.vel+=-.018*l-.18*r.vel,r.mesh.position.y+=r.vel)}for(const r of this._sceneObjs)r.userData&&r.userData.floatIdx!==void 0&&(r.position.y=r.userData.baseY+Math.sin(s*.55+r.userData.floatIdx*1.1)*.018);for(const r of this._fireObjs){r.t+=.04;const l=(Math.sin(r.t*3.1)+1)*.5;r.mat.emissive=new A(16729088),r.mat.emissiveIntensity=.4+l*.6,r.mat.color=new A(16720384)}if(this._sparks=this._sparks.filter(r=>(r.life-=.024,r.life<=0?(this._three.scene.remove(r.mesh),!1):(r.vel.y-=.005,r.mesh.position.addScaledVector(r.vel,1),r.mesh.material.opacity=r.life,!0))),o.t==="color"||o.t==="cquiz"||o.t==="color_sum"){for(const r of this._sceneObjs)if(r.isMesh&&r.userData.wireId&&!r.material.transparent){const l=pe.find(c=>c.id===r.userData.wireId);if(l&&this._cqActive){const c=this._cqTargetId===l.id;r.material.emissive=new A(l.col),r.material.emissiveIntensity=c?.08+Math.sin(s*3)*.08:0}}}}_spawnSparks(t){if(this._three)for(let e=0;e<16;e++){const s=new J({color:[16763904,16737792,16777215][e%3],transparent:!0,opacity:1}),o=new p(new gt(.032,4,4),s);o.position.copy(t),this._three.scene.add(o),this._sparks.push({mesh:o,life:.7+Math.random()*.6,vel:new m((Math.random()-.5)*.09,.05+Math.random()*.09,(Math.random()-.5)*.09)})}}_showFeedback(t){const e=this._el.querySelector("#wtl-feedback");this._el.querySelector("#wtl-fb").textContent=t,e.classList.add("show"),setTimeout(()=>e.classList.remove("show"),800)}_startColorQuiz(){this._cqIdx=0,this._cqCorrect=0,this._cqActive=!0,this._renderColorQuizRound(),this._el.querySelector("#wtl-next").disabled=!0}_renderColorQuizRound(){const t=[{id:"red",role:"HOT",hex:"#cc2222"},{id:"white",role:"NEUTRAL",hex:"#d8d8d8"},{id:"green",role:"GROUND",hex:"#1a9e44"}],e=t[this._cqIdx];this._cqTargetId=e.id;const s=Math.round(this._step/(rt.length-1)*100);this._el.querySelector("#wtl-dialog").innerHTML=`
      ...
      <div class="wtl-progress-row">
        ...
        <span class="wtl-prog-pct" id="wtl-pct">${s}%</span>
      </div>`,this._el.querySelector("#wtl-tap-hint").style.display="block"}_onColorTap(t,e){if(this._cqActive)if(t===this._cqTargetId)if(this._showFeedback("✅"),this._spawnSparks(e),this._cqCorrect++,this._cqIdx++,this._cqIdx>=3){this._cqActive=!1,this._el.querySelector("#wtl-tap-hint").style.display="none",this._el.querySelector("#wtl-next").disabled=!1,this._el.querySelector("#wtl-next").textContent="NEXT CHAPTER";const s=Math.round(this._step/(rt.length-1)*100);this._el.querySelector("#wtl-dialog").innerHTML=`
          ...
          <div class="wtl-progress-row">
            <div class="wtl-prog-bar"><div class="wtl-prog-fill" id="wtl-prog" style="width:${s}%"></div></div>
            <span class="wtl-prog-pct" id="wtl-pct">${s}%</span>
          </div>`}else setTimeout(()=>this._renderColorQuizRound(),450);else{this._showFeedback("❌");const s=this._el.querySelector("#wtl-cq-inline");s&&(s.classList.remove("shake"),s.offsetWidth,s.classList.add("shake"))}}_renderQuiz(t){const e=Zt[t],s=this._el.querySelector("#wtl-dialog");s.innerHTML=`
      ...
      <div class="wtl-progress-row">
        <div class="wtl-prog-bar"><div class="wtl-prog-fill" id="wtl-prog"></div></div>
        <span class="wtl-prog-pct" id="wtl-pct"></span>
      </div>`,s.querySelectorAll(".wtl-opt").forEach(o=>{o.addEventListener("click",()=>this._onQuizAnswer(t,parseInt(o.dataset.idx)))})}_onQuizAnswer(t,e){if(this._quizDone)return;const s=Zt[t];if(this._el.querySelectorAll(".wtl-opt").forEach((i,a)=>{i.style.pointerEvents="none",a===s.ans?i.classList.add("correct"):a===e&&i.classList.add("wrong")}),e===s.ans)this._showFeedback("✅"),this._quizDone=!0,this._el.querySelector("#wtl-next").disabled=!1;else{this._showFeedback("❌");const i=this._el.querySelector("#wtl-quiz-hint");i&&i.classList.add("show"),setTimeout(()=>{this._quizDone=!0,this._el.querySelector("#wtl-next").disabled=!1},900)}}_render(){const t=rt[this._step],e=rt.length,s=Math.round(this._step/(e-1)*100);this._el.querySelector("#wtl-ch-lbl").textContent=t.chLbl||"",this._el.querySelector("#wtl-step-num").textContent=`${this._step+1}/${e}`;const o=this._el.querySelector("#wtl-dots");o.innerHTML=rt.map((n,r)=>`<div class="wtl-dot ${r<this._step?"done":r===this._step?"active":""}"></div>`).join("");const i=this._el.querySelector("#wtl-next"),a=this._el.querySelector("#wtl-prev");if(a.style.visibility=this._step===0?"hidden":"visible",t.t==="quiz")this._quizDone=!1,i.disabled=!0,i.textContent="NEXT →",this._renderQuiz(t.qi),requestAnimationFrame(()=>{const n=this._el.querySelector("#wtl-prog"),r=this._el.querySelector("#wtl-pct");n&&(n.style.width=s+"%"),r&&(r.textContent=s+"%")});else{this._el.querySelector("#wtl-bubble")||(this._el.querySelector("#wtl-dialog").innerHTML=`
          <div class="wtl-bubble" id="wtl-bubble">
            <div class="wtl-bubble-content">
              <div class="wtl-bubble-name">ELECTRO
                <div class="wtl-wave"><span></span><span></span><span></span></div>
...
`;function ys(){if(document.querySelector("#etl-css"))return;const f=document.createElement("style");f.id="etl-css",f.textContent=vs,document.head.appendChild(f)}class ks{constructor(t){this.state=t,this._step=0,this._renderer=null,this._raf=null,this._toolMeshes={},this._quizAnswered=!1,this._quizScore=0,this._targetCam=null,this._camTarget=new m,this._camPos=new m,this.container=this._build()}_build(){ys();const t=document.createElement("div");t.className="screen screen-hidden",t.innerHTML=`
      <div class="etl">
      ...
      </div>`;const e=t.querySelector(".etl-back"),s=()=>this.state.setState("stagesHub");return e.addEventListener("click",s),e.addEventListener("touchend",o=>{o.preventDefault(),s()}),this._el=t,t}_initThree(){if(this._renderer)return;const t=this._el.querySelector("#etl-canvas"),e=this._el.querySelector("#etl-scene"),s=e.offsetWidth,o=e.offsetHeight;if(!s||!o){setTimeout(()=>this._initThree(),60);return}this._renderer=new _t({canvas:t,antialias:!0,alpha:!1}),this._renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this._renderer.setSize(s,o),this._renderer.setClearColor(395796),this._renderer.shadowMap.enabled=!0,this._renderer.shadowMap.type=Nt,this._renderer.toneMapping=Wt,this._renderer.toneMappingExposure=1.3,this._scene=new mt,this._scene.background=new A(395796),this._scene.fog=new $t(395796,.018),this._camera=new xt(52,s/o,.1,100);const i=it[0].cam??{p:[0,3,8],t:[0,0,0]};this._camera.position.set(...i.p),this._camTarget.set(...i.t),this._camera.lookAt(this._camTarget),this._targetCam=i,oe(this._scene),ie(this._scene,{benchY:-.07,benchW:15,benchD:5}),this._toolSpot=new At(16772829,5.5),this._toolSpot.position.set(1.8,4.5,2.2),this._toolSpot.target.position.set(0,.1,0),this._toolSpot.angle=.38,this._toolSpot.penumbra=.55,this._toolSpot.decay=1.4,this._toolSpot.castShadow=!0,this._toolSpot.shadow.mapSize.set(1024,1024),this._toolSpot.shadow.bias=-.002,this._scene.add(this._toolSpot),this._scene.add(this._toolSpot.target),this._rimLight=new U(3368703,.55),this._rimLight.position.set(-3,3,-4),this._scene.add(this._rimLight);for(const a of Qt){const n=this[`_build_${a.id}`](a);n.visible=!1,this._scene.add(n),this._toolMeshes[a.id]=n,n.userData.baseY=n.position.y,n.userData.baseRx=n.rotation.x,n.userData.baseScale=n.scale.x,n.userData.displayRz=a.displayRz??0}this._resizeObs=new ResizeObserver(()=>{const a=e.offsetWidth,n=e.offsetHeight;!a||!n||(this._camera.aspect=a/n,this._camera.updateProjectionMatrix(),this._renderer.setSize(a,n))}),this._resizeObs.observe(e),this._tick(),it[this._step]&&this._applyScene(it[this._step].scene,it[this._step])}_mat(t,e=.2,s=.65){return new g({color:t,metalness:e,roughness:s})}_build_lineman(){const t=new O,e=new g({color:7237230,roughness:.22,metalness:.88}),s=new g({color:3355443,roughness:.35,metalness:.8}),o=new g({color:11184810,roughness:.12,metalness:.95}),i=new g({color:13373713,roughness:.78,metalness:0}),a=new g({color:1118481,roughness:.76,metalness:0}),n=new g({color:10030606,roughness:.85,metalness:0}),r=new g({color:1710618,roughness:.85,metalness:0}),l=new O,c=new O,d=new p(new y(.62,.052,.16),e);d.position.set(.2,.66-.47,0),l.add(d);for(let x=0;x<9;x++){const k=new p(new y(.042,.022,.163),s);k.position.set(-.16+x*.065,.686-.47,0),l.add(k)}const h=new p(new y(.058,.28,.13),e);h.position.set(-.045,.33-.47,0),l.add(h);const u=new p(new ct(.052,.55,6,14),i);u.position.set(-.092,.05-.47,0),u.rotation.z=.24,l.add(u);for(let x=0;x<6;x++){const k=new p(new $(.054,.008,6,18),n);k.position.set(-.092+Math.sin(.24)*(-.1+x*.065),.2-.47-x*.075,0),k.rotation.set(Math.PI/2,0,.24),l.add(k)}const w=new p(new y(.08,.042,.082),s);w.position.set(-.07,.475-.47,.041),l.add(w);const b=new p(new y(.62,.052,.16),e);b.position.set(.2,.604-.47,0),c.add(b);for(let x=0;x<9;x++){const k=new p(new y(.042,.022,.163),s);k.position.set(-.16+x*.065,.583-.47,0),c.add(k)}const _=new p(new y(.058,.28,.13),e);_.position.set(.045,.33-.47,0),c.add(_);const v=new p(new ct(.052,.55,6,14),a);v.position.set(.092,.05-.47,0),v.rotation.z=-.24,c.add(v);for(let x=0;x<6;x++){const k=new p(new $(.054,.008,6,18),r);k.position.set(.092+Math.sin(-.24)*(-.1+x*.065),.2-.47-x*.075,0),k.rotation.set(Math.PI/2,0,-.24),c.add(k)}const S=new p(new y(.08,.042,.082),s);S.position.set(-.07,.475-.47,-.041),c.add(S),l.position.y=.47,c.position.y=.47;const E=new p(new T(.048,.048,.19,6),o);E.rotation.x=Math.PI/2,E.position.set(0,.47,0),t.add(E);const z=new p(new T(.044,.044,.008,6),s);return z.rotation.x=Math.PI/2,z.position.set(0,.47,.098),t.add(z),t.add(l),t.add(c),t.userData.armA=l,t.userData.armB=c,t.position.y=.08,t}_build_dykes(){const t=new O,e=this._mat(6710886,.8,.3),s=new O,o=new O,i=new p(new y(.13,.032,.07),e);i.position.set(-.04,.4-.28,0),i.rotation.z=-.32,s.add(i);const a=new p(new ct(.032,.36,4,8),this._mat(3364266));a.position.set(.05,.04-.28,0),a.rotation.z=.18,s.add(a);const n=new p(new y(.13,.032,.07),e);n.position.set(.04,.4-.28,0),n.rotation.z=.32,o.add(n);const r=new p(new ct(.032,.36,4,8),this._mat(1710638));r.position.set(-.05,-.15-.28,0),r.rotation.z=-.18,o.add(r),s.position.y=.28,o.position.y=.28;const l=new p(new T(.022,.022,.11,8),e);return l.rotation.x=Math.PI/2,l.position.y=.28,t.add(l),t.add(s),t.add(o),t.userData.armA=s,t.userData.armB=o,t.position.y=.08,t}_build_knife(){const t=new O,e=new p(new y(.1,.17,.52),this._mat(5592422));e.position.y=.085,t.add(e);const s=new p(new y(.006,.072,.28),this._mat(13158600,.9,.2));s.position.set(0,.12,-.34),t.add(s);const o=new p(new y(.006,.04,.06),this._mat(13158600,.9,.2));o.position.set(0,.09,-.45),o.rotation.x=.4,t.add(o);const i=new p(new y(.042,.058,.042),this._mat(3355460));return i.position.set(.073,.13,-.08),t.add(i),t.position.y=.085,t}_build_longnose(){const t=new O,e=new g({color:8026746,roughness:.2,metalness:.9}),s=new g({color:3355443,roughness:.35,metalness:.8}),o=new g({color:12303291,roughness:.1,metalness:.96}),i=new g({color:14492194,roughness:.76,metalness:0}),a=new g({color:1118481,roughness:.76,metalness:0}),n=new O,r=new O,l=new p(new y(.048,.8,.1),e);l.position.set(.022,.72-.22,0),l.rotation.z=.03,n.add(l);for(let b=0;b<7;b++){const _=new p(new y(.012,.044,.102),s);_.position.set(.01,.42-.22+b*.065,0),n.add(_)}const c=new p(new ct(.042,.5,5,12),i);c.position.set(.068,-.08-.22,0),c.rotation.z=.15,n.add(c);for(let b=0;b<5;b++){const _=new p(new $(.044,.007,6,16),new g({color:11145489,roughness:.85}));_.position.set(.068+Math.sin(.15)*(-.05+b*.058),-.02-.22-b*.068,0),_.rotation.set(Math.PI/2,0,.15),n.add(_)}const d=new p(new y(.048,.8,.1),e);d.position.set(-.022,.72-.22,0),d.rotation.z=-.03,r.add(d);for(let b=0;b<7;b++){const _=new p(new y(.012,.044,.102),s);_.position.set(-.01,.42-.22+b*.065,0),r.add(_)}const h=new p(new ct(.042,.5,5,12),a);h.position.set(-.068,-.08-.22,0),h.rotation.z=-.15,r.add(h);for(let b=0;b<5;b++){const _=new p(new $(.044,.007,6,16),new g({color:2236962,roughness:.85}));_.position.set(-.068+Math.sin(-.15)*(-.05+b*.058),-.02-.22-b*.068,0),_.rotation.set(Math.PI/2,0,-.15),r.add(_)}n.position.y=.22,r.position.y=.22;const u=new p(new T(.036,.036,.15,6),o);u.rotation.x=Math.PI/2,u.position.set(0,.22,0),t.add(u);const w=new O;for(let b=0;b<8;b++){const _=b/7*Math.PI,v=new p(new y(.012,.012,.012),new g({color:11184810,roughness:.3,metalness:.85}));v.position.set(Math.cos(_)*.055,.02,Math.sin(_)*.055),w.add(v)}return t.add(w),t.add(n),t.add(r),t.userData.armA=n,t.userData.armB=r,t.userData.spring=w,t.position.y=.08,t}_build_conduitbender(){const t=new O,e=this._mat(14505216,.3,.7),s=this._mat(8947848,.8,.3),o=[];for(let l=0;l<=20;l++){const c=l/20*(Math.PI*.6)-.12;o.push(new m(Math.sin(c)*.88,Math.cos(c)*.88,0))}const i=new p(new dt(new ut(o),20,.044,8,!1),e);i.position.set(0,.08,0),t.add(i);const a=new p(new T(.024,.024,1.45,8),s);a.position.set(0,-.68,0),t.add(a);const n=new p(new y(.14,.04,.09),e);n.position.set(-.34,.07,0),t.add(n);const r=new p(new y(.022,.022,.065),this._mat(16772608,0,1));return r.position.set(-.61,.73,.05),t.add(r),t.scale.setScalar(.85),t.position.y=.1,t}_build_flathead(){const t=new O,e=new g({color:10066329,roughness:.18,metalness:.92}),s=new g({color:13421772,roughness:.1,metalness:.96}),o=new g({color:16750848,roughness:.72,metalness:0}),i=new g({color:13399808,roughness:.82,metalness:0});for(let h=0;h<3;h++){const u=h/3*Math.PI*2,w=new p(new T(.052,.044,.46,10),o);w.position.set(Math.cos(u)*.02,.44,Math.sin(u)*.02),t.add(w)}const a=new p(new T(.058,.058,.028,14),i);a.position.y=.685,t.add(a);const n=new p(new T(.04,.035,.045,14),s);n.position.y=.195,t.add(n);for(let h=0;h<5;h++){const u=new p(new $(.056,.007,6,16),i);u.position.y=.6-h*.072,u.rotation.x=Math.PI/2,t.add(u)}const r=new p(new T(.018,.018,.18,6),e);r.position.y=.085,t.add(r);const l=new p(new T(.013,.013,.24,10),e);l.position.y=-.075,t.add(l);const c=new p(new y(.095,.01,.018),s);c.position.y=-.215,t.add(c);const d=new p(new y(.095,.005,.012),s);return d.position.y=-.222,t.add(d),t.position.y=.23,t}_build_phillips(){const t=new O,e=new g({color:10066329,roughness:.18,metalness:.92}),s=new g({color:13421772,roughness:.1,metalness:.96}),o=new g({color:16737792,roughness:.72,metalness:0}),i=new g({color:13386752,roughness:.82,metalness:0});for(let d=0;d<3;d++){const h=d/3*Math.PI*2,u=new p(new T(.052,.044,.46,10),o);u.position.set(Math.cos(h)*.02,.44,Math.sin(h)*.02),t.add(u)}const a=new p(new T(.058,.058,.028,14),i);a.position.y=.685,t.add(a);const n=new p(new T(.04,.035,.045,14),s);n.position.y=.195,t.add(n);for(let d=0;d<5;d++){const h=new p(new $(.056,.007,6,16),i);h.position.y=.6-d*.072,h.rotation.x=Math.PI/2,t.add(h)}const r=new p(new T(.018,.018,.18,6),e);r.position.y=.085,t.add(r);const l=new p(new T(.013,.013,.24,10),e);l.position.y=-.075,t.add(l),[0,1].forEach(d=>{const h=new p(new y(.082,.012,.016),s);h.position.y=-.212,h.rotation.y=d*Math.PI/2,t.add(h)});const c=new p(new te(.014,.028,8),s);return c.position.y=-.232,c.rotation.x=Math.PI,t.add(c),t.position.y=.23,t}_build_tape(){const t=new O,e=new p(new $(.27,.09,12,32),this._mat(1118481,.1,.9));e.rotation.x=Math.PI/2,t.add(e);const s=new p(new T(.17,.17,.18,16),this._mat(2761240,.1,.9));return t.add(s),t.scale.setScalar(.8),t.position.y=.22,t}_build_tester(){const t=new O,e=new g({color:16763904,roughness:.6,metalness:.1}),s=new g({color:1118481,roughness:.8,metalness:0}),o=new g({color:16777215,roughness:.1,transmission:.9,transparent:!0,opacity:.5}),i=new g({color:15658734,roughness:.4,metalness:.4}),a=new p(new T(.045,.038,.65,16),e);a.position.y=.12,t.add(a);const n=new p(new T(.04,.03,.28,16),s);n.position.y=-.34,t.add(n);for(let v=0;v<4;v++){const S=new p(new $(.042-v*.002,.005,6,16),s);S.position.y=-.25-v*.06,S.rotation.x=Math.PI/2,t.add(S)}const r=new p(new T(.015,.026,.22,12),i);r.position.y=-.59,t.add(r);const l=new p(new te(.015,.04,12),i);l.position.y=-.72,l.rotation.x=Math.PI,t.add(l);const c=new p(new T(.045,.045,.06,16),s);c.position.y=.47,t.add(c);const d=new p(new gt(.035,12,12,0,Math.PI*2,0,Math.PI/2),o);d.position.y=.5,t.add(d);const h=new p(new gt(.018,8,8),new g({color:16720384,emissive:16720384,emissiveIntensity:1.2}));h.position.set(0,.49,0),t.add(h);const u=new p(new y(.05,.02,.06),s);u.position.set(-.04,.45,0),t.add(u);const w=new p(new y(.015,.4,.03),s);w.position.set(-.06,.25,0),t.add(w);const b=new p(new y(.022,.02,.03),s);b.position.set(-.055,.05,0),t.add(b);const _=new p(new y(.018,.06,.03),s);return _.position.set(.042,.2,0),t.add(_),t.scale.setScalar(.88),t.position.y=.45,t}_build_multimeter(){const t=new O,e=new g({color:1710618,roughness:.65,metalness:0}),s=new g({color:16755200,roughness:.85,metalness:0}),o=new g({color:13373713,roughness:.5,metalness:.2}),i=new g({color:1118481,roughness:.5,metalness:.2}),a=new p(new y(.38,.6,.08),e);t.add(a);const n=new p(new y(.44,.64,.09),s);n.position.z=-.01,t.add(n);const r=document.createElement("canvas");r.width=128,r.height=64;const l=r.getContext("2d");l.fillStyle="#a1b5a5",l.fillRect(0,0,128,64),l.fillStyle="#111111",l.font="bold 42px monospace",l.fillText("120.4",8,48),l.font="14px sans-serif",l.fillText("V~",104,48);const c=new ft(r),d=new p(new y(.28,.16,.02),new g({map:c,roughness:.2,metalness:.1}));d.position.set(0,.16,.041),t.add(d);const h=new p(new y(.3,.18,.015),e);h.position.set(0,.16,.04),t.add(h);const u=new p(new T(.11,.11,.015,24),e);u.rotation.x=Math.PI/2,u.position.set(0,-.06,.04),t.add(u);const w=new p(new T(.08,.08,.03,16),e);w.rotation.x=Math.PI/2,w.position.set(0,-.06,.05),t.add(w);for(let _=0;_<8;_++){const v=_/8*Math.PI*2,S=new p(new y(.02,.035,.025),e);S.position.set(Math.cos(v)*.08,-.06+Math.sin(v)*.08,.05),t.add(S)}const b=new p(new y(.012,.08,.035),new g({color:16777215}));return b.position.set(0,-.02,.05),t.add(b),[-.1,0,.1].forEach((_,v)=>{const S=new p(new T(.02,.02,.02,12),v===0?i:o);S.rotation.x=Math.PI/2,S.position.set(_,-.24,.042),t.add(S);const E=new p(new T(.012,.012,.022,12),new g({color:0}));E.rotation.x=Math.PI/2,E.position.set(_,-.24,.044),t.add(E)}),t.scale.setScalar(.78),t.position.y=.24,t}_build_fishtape(){const t=new O,e=this._mat(16737792,.2,.7),s=new p(new T(.32,.32,.14,20),e);t.add(s),[-.08,.08].forEach(a=>{const n=new p(new T(.35,.35,.02,20),this._mat(14500864,.2,.7));n.position.y=a,t.add(n)});const o=new p(new ct(.028,.22,4,8),this._mat(3355443,.1,.8));o.position.set(.36,.14,0),o.rotation.z=Math.PI/2,t.add(o);const i=new p(new y(.24,.012,.018),this._mat(8947848,.8,.3));return i.position.set(.34,0,0),t.add(i),t.rotation.x=Math.PI/2,t.scale.setScalar(.85),t.position.y=.27,t}_build_measuringtape(){const t=new O,e=new p(new y(.38,.22,.28),this._mat(16763904,.1,.7));t.add(e);for(let i=0;i<4;i++){const a=new p(new y(.005,.22,.28),this._mat(14526976,.1,.8));a.position.x=-.15+i*.1,t.add(a)}const s=new p(new y(.42,.018,.022),this._mat(14540253,.6,.4));s.position.set(.4,.06,.06),t.add(s);const o=new p(new y(.018,.26,.02),this._mat(5592405,.7,.4));return o.position.set(-.2,.02,.15),t.add(o),t.scale.setScalar(.85),t.position.y=.1,t}_applyScene(t,e){var n,r,l;for(const c of Object.values(this._toolMeshes))c.visible=!1,c.rotation.set(0,0,0),c.scale.setScalar(1);const s=(e==null?void 0:e.cam)??{p:[0,3,8],t:[0,0,0]};if(this._targetCam=s,t==="bench_clean")return;if(t==="all_tools"){Qt.forEach(c=>{const d=this._toolMeshes[c.id];d.visible=!0,d.position.set(-2.5+c.xi*1.02,.08,-.65+c.row*1.32),d.rotation.set(-Math.PI/2,0,0),d.scale.setScalar(.65)});return}const o={cutting_group:["lineman","dykes","knife"],gripping_group:["longnose","conduitbender"],fastening_group:["flathead","phillips"],testing_group:["tester","multimeter","fishtape","measuringtape"]};if(o[t]){const c=o[t],d=(c.length-1)*1.65;c.forEach((h,u)=>{const w=this._toolMeshes[h];w.visible=!0,w.position.set(-d/2+u*1.65,.08,0),w.rotation.set(-Math.PI/2,0,0),w.scale.setScalar(.85)});return}this._animProps&&(this._scene.remove(this._animProps),this._animProps=null);const i=t.startsWith("show_")||t.startsWith("anim_")||t==="quiz";if(this._toolSpot&&(this._toolSpot.intensity=i?5.5:0),this._rimLight&&(this._rimLight.intensity=i?.55:.18),t.startsWith("show_")||t==="quiz"?this._targetCam={p:[.35,1.5,2.8],t:[0,1,0]}:t.startsWith("anim_")&&(this._targetCam={p:[0,1.5,3],t:[0,1,0]}),i){const c=t==="quiz"?((n=Et[e==null?void 0:e.qi])==null?void 0:n.vis)??null:t.split("_")[1],d=c?this._toolMeshes[c]:null;if(d){d.visible=!0;const u=(d.userData.baseScale??1)*2;d.scale.setScalar(u);const w=Qt.find(S=>S.id===c),b=(w==null?void 0:w.displayRz)??0;d.rotation.set(d.userData.baseRx??0,.42,b),d.position.set(0,100,.1),d.updateMatrixWorld(!0);const _=new me().setFromObject(d),v=100.02-_.min.y;if(d.position.y=v,d.userData.displayY=v,this._toolSpot){const S=v-100,E=(_.min.y+_.max.y)*.5+S,z=_.max.y+S;this._toolSpot.target.position.set(.1,E,.1),this._toolSpot.target.updateMatrixWorld(),this._toolSpot.position.set(1.6,z+3.2,2)}}const h=(r=this._el)==null?void 0:r.querySelector("#etl-tool-overlay");if(h&&d&&c){const u=Qt.find(w=>w.id===c);h.textContent=(u==null?void 0:u.name)??"",h.classList.toggle("show",!!u&&t!=="quiz")}else h&&h.classList.remove("show");if(t.startsWith("anim_")){if(this._animProps=new O,this._animProps.position.set(0,(d==null?void 0:d.userData.displayY)??.2,.1),this._scene.add(this._animProps),c==="lineman"||c==="dykes"){const u=new p(new T(.038,.038,1.6,12),this._mat(13382451,.1,.7));u.rotation.z=Math.PI/2,u.position.set(.1,.18,0),this._animProps.add(u);const w=new p(new T(.028,.028,.12,8),this._mat(14252101,.1,.85));w.rotation.z=Math.PI/2,w.position.set(.82,.18,0),this._animProps.add(w)}else if(c==="flathead"||c==="phillips"){const u=new p(new T(.09,.07,.12,12),this._mat(8947848,.8,.3));u.position.set(0,-.22,0),this._animProps.add(u);const w=new p(new T(.07,.07,.6,12),this._mat(5592405,.5,.5));w.position.set(0,-.58,0),this._animProps.add(w)}else if(c==="tester"){const u=new p(new T(.038,.038,1.6,12),this._mat(1118481,.1,.7));u.rotation.z=Math.PI/2,u.position.set(.2,-.3,0),this._animProps.add(u)}}return}const a=(l=this._el)==null?void 0:l.querySelector("#etl-tool-overlay");a&&a.classList.remove("show")}_gotoStep(t){this._step=t,this._quizAnswered=!1;const e=it[t];this._el.querySelector("#etl-chlbl").textContent=e.chLbl??"TOOLS",this._el.querySelector("#etl-prog").textContent=`${t+1}/${it.length}`,this._el.querySelector(".etl").classList.toggle("etl--quiz",e.t==="quiz"),this._applyScene(e.scene,e),this._renderDialog(e),this._renderNav(e)}_renderDialog(t){const e=this._el.querySelector("#etl-dialog");if(t.t==="chap"){e.innerHTML=`
        ...
        </div>`;return}if(t.t==="quiz"){const s=Et[t.qi],o=Et.map((i,a)=>`<div class="etl-quiz-pip ${a<t.qi?"done":a===t.qi?"active":""}"></div>`).join("");e.innerHTML=`
        ...
        </div>`,e.querySelectorAll(".etl-quiz-opt").forEach(i=>{i.addEventListener("click",()=>this._onQuizAnswer(parseInt(i.dataset.i)))});return}if(t.t==="done"){const s=this._quizScore>=5?"#2dc653":this._quizScore>=3?"#ffaa22":"#ff4444";e.innerHTML=`
        <div class="etl-dlg-title">${t.title}</div>
        <div style="font-family:'Barlow Condensed',sans-serif;font-size:14px;font-weight:700;color:${s};letter-spacing:2px;">QUIZ: ${this._quizScore}/${Et.length} CORRECT</div>
        <div class="etl-dlg-body">${t.text}</div>`;return}if(t.t==="tool"){const s=t.features.map(([i,a])=>`
        <div class="etl-feat-item">
          <span class="etl-feat-icon">${i}</span>
          <span class="etl-feat-label">${a}</span>
        </div>`).join(""),o=t.howTo.map((i,a)=>`
        <div class="etl-step">
...
`;function Ss(){if(document.querySelector("#wsl-css"))return;const f=document.createElement("style");f.id="wsl-css",f.textContent=Ts,document.head.appendChild(f)}function Mt(f,t){const e=document.createElement("canvas");e.width=160,e.height=50;const s=e.getContext("2d");s.fillStyle="rgba(4,10,24,0.9)",s.beginPath(),s.roundRect(2,2,156,46,9),s.fill(),s.strokeStyle=f,s.lineWidth=2,s.beginPath(),s.roundRect(2,2,156,46,9),s.stroke(),s.fillStyle=f,s.font="bold 17px monospace",s.textAlign="center",s.textBaseline="middle",s.fillText(t,80,25);const o=new ft(e),i=new Oe({map:o,transparent:!0,depthTest:!1}),a=new Re(i);return a.scale.set(.82,.27,1),a}function zt(f){return f<.5?2*f*f:-1+(4-2*f)*f}class Es{constructor(t){this.state=t,this._step=0,this._three=null,this._animId=null,this._sceneObjs=[],this._dropObjs=[],this._tsGroups=[],this._tsActive=!1,this._tsAnswered=!1,this._animObjs={},this._animT=0,this._animScene=null,this._lastTime=0,this._sparks=[],this._quizDone=!1,this._camPos=new m(0,2.5,7.5),this._camTarget=new m(0,-.3,0),this.container=this._build()}_build(){Ss();const t=document.createElement("div");return t.className="screen screen-hidden",t.innerHTML=`
      <div class="wsl">
      ...
      </div>`,t.querySelector(".wsl-back").addEventListener("click",()=>this.state.setState("stagesHub")),t.querySelector("#wsl-next").addEventListener("click",()=>this._onNext()),t.querySelector("#wsl-prev").addEventListener("click",()=>this._onPrev()),t.querySelector("#wsl-bubble-tap").addEventListener("click",()=>this._onNext()),this._el=t,t}_initThree(){if(this._three)return;const t=this._el.querySelector("#wsl-canvas"),e=this._el.querySelector("#wsl-scene"),s=e.offsetWidth,o=e.offsetHeight;if(!s||!o){setTimeout(()=>this._initThree(),60);return}const i=new _t({canvas:t,antialias:!0,powerPreference:"high-performance"});i.setPixelRatio(Math.min(devicePixelRatio,2)),i.setSize(s,o),i.shadowMap.enabled=!0,i.shadowMap.type=Nt,i.toneMapping=Wt,i.toneMappingExposure=1.1;const a=new mt;a.background=new A(658968),a.fog=new $t(658968,.025);const n=new xt(50,s/o,.1,80);n.position.copy(this._camPos),n.lookAt(this._camTarget),oe(a);const{lampFill:r}=ie(a,{benchY:-.64,benchW:12,benchD:5.5}),l=r,c=new Dt,d=new Ot,h=w=>{if(!this._tsActive)return;w.preventDefault();const b=t.getBoundingClientRect(),_=w.touches?w.changedTouches[0]:w;d.x=(_.clientX-b.left)/b.width*2-1,d.y=-((_.clientY-b.top)/b.height)*2+1,c.setFromCamera(d,n);const v=c.intersectObjects(this._tsGroups,!0);if(v.length){let S=v[0].object,E=S.userData.toolId;for(;!E&&S.parent;)S=S.parent,E=S.userData.toolId;E&&this._onToolTap(E,v[0].point)}};t.addEventListener("pointerdown",h),this._resizeObs=new ResizeObserver(()=>{const w=e.offsetWidth,b=e.offsetHeight;!w||!b||(i.setSize(w,b),n.aspect=w/b,n.updateProjectionMatrix())}),this._resizeObs.observe(e),this._three={renderer:i,scene:a,camera:n,lamp:l},this._lastTime=performance.now()*.001;const u=()=>{this._animId=requestAnimationFrame(u),this._updateThree(),i.render(a,n)};u()}_clearSceneObjs(){if(!this._three)return;for(const e of this._sceneObjs)this._three.scene.remove(e);this._sceneObjs=[],this._dropObjs=[],this._tsGroups=[],this._tsActive=!1,this._tsAnswered=!1,this._animObjs={},this._animScene=null,this._el.querySelector("#wsl-tool-badge").classList.remove("show");const t=this._el.querySelector("#wsl-quality-badge");t.className="wsl-quality-badge",this._el.querySelector("#wsl-tap-hint").style.display="none"}_add(t){return this._three.scene.add(t),this._sceneObjs.push(t),t}_tagMeshes(t,e){t.userData.toolId=e,t.traverse(s=>{s.isMesh&&(s.userData.toolId=e)})}_buildManual(t=1){const e=new O,s=new g({color:13373713,roughness:.75,metalness:0}),o=new g({color:7237230,roughness:.22,metalness:.88}),i=new g({color:2236962,roughness:.35,metalness:.8}),a=new g({color:11184810,roughness:.12,metalness:.95}),n=new g({color:16755200,roughness:.8,metalness:0}),r=new O,l=new p(new ct(.08*t,.72*t,6,14),s);l.position.set(-.52*t,.16*t,0),l.rotation.z=.35,r.add(l);for(let x=0;x<8;x++){const k=new p(new $(.082*t,.015*t,6,18),new g({color:10030606}));k.position.set(-.52*t+Math.sin(.35)*(-.16+x*.09)*t,.16*t-Math.cos(.35)*(-.16+x*.09)*t,0),k.rotation.set(Math.PI/2,0,.35),r.add(k)}const c=new p(new y(.25*t,.08*t,.12*t),o);c.position.set(-.1*t,.04*t,0),c.rotation.z=.15,r.add(c);const d=new p(new y(.56*t,.065*t,.16*t),o);d.position.set(.38*t,-.065*t,0),r.add(d);const h=new p(new y(.12*t,.05*t,.16*t),i);h.position.set(.12*t,-.02*t,0),r.add(h);const u=new O,w=new p(new ct(.08*t,.72*t,6,14),s);w.position.set(-.52*t,-.16*t,0),w.rotation.z=-.35,u.add(w);for(let x=0;x<8;x++){const k=new p(new $(.082*t,.015*t,6,18),new g({color:10030606}));k.position.set(-.52*t+Math.sin(-.35)*(-.16+x*.09)*t,-.16*t-Math.cos(-.35)*(-.16+x*.09)*t,0),k.rotation.set(Math.PI/2,0,-.35),u.add(k)}const b=new p(new y(.25*t,.08*t,.12*t),o);b.position.set(-.1*t,-.04*t,0),b.rotation.z=-.15,u.add(b);const _=new p(new y(.56*t,.065*t,.16*t),o);_.position.set(.38*t,.065*t,0),u.add(_);const v=new p(new y(.12*t,.05*t,.16*t),i);v.position.set(.12*t,.02*t,0),u.add(v);const S=new p(new T(.065*t,.065*t,.22*t,6),a);S.rotation.x=Math.PI/2;for(let x=0;x<8;x++){const k=x/7*Math.PI,M=new p(new y(.015*t,.015*t,.015*t),a);M.position.set(-.32*t,Math.cos(k)*.1*t,Math.sin(k)*.06*t),e.add(M)}[.26,.36,.46,.56].forEach((x,k)=>{const M=(.045-k*.008)*t,I=new p(new T(M,M,.18*t,12),i);I.rotation.x=Math.PI/2,I.position.set(x*t,0,0),e.add(I);const P=new p(new y(.025*t,.04*t,.17*t),n);P.position.set(x*t,.04*t,0),u.add(P)});const E=new p(new y(.08*t,.03*t,.16*t),o);E.position.set(.62*t,-.01*t,0),r.add(E);const z=new p(new y(.08*t,.03*t,.16*t),o);z.position.set(.62*t,.01*t,0),u.add(z);for(let x=0;x<4;x++){const k=new p(new y(.015*t,.01*t,.16*t),i);k.position.set((.59+x*.02)*t,.01*t,0),r.add(k);const M=new p(new y(.015*t,.01*t,.16*t),i);M.position.set((.59+x*.02)*t,-.01*t,0),u.add(M)}return e.add(r),e.add(u),e.add(S),e.userData.armA=r,e.userData.armB=u,e}_buildAutomatic(t=1){const e=new O,s=new g({color:1136076,roughness:.6}),o=new g({color:666214,roughness:.7}),i=new g({color:8947848,roughness:.25,metalness:.9}),a=new g({color:1118481,roughness:.5}),n=new p(new y(1.1*t,.36*t,.28*t),s.clone());n.position.set(0,.05*t,0),e.add(n);const r=new p(new y(.9*t,.06*t,.24*t),o.clone());r.position.set(-.05*t,.26*t,0),e.add(r);const l=new p(new ct(.11*t,.52*t,5,14),s.clone());l.position.set(.05*t,-.36*t,0),l.rotation.z=.22,e.add(l);const c=new p(new y(.06*t,.26*t,.12*t),o.clone());c.position.set(.14*t,-.14*t,0),c.rotation.z=.18,e.add(c);const d=new p(new y(.28*t,.32*t,.26*t),i.clone());d.position.set(.6*t,.05*t,0),e.add(d);const h=new p(new T(.065*t,.065*t,.3*t,14),a.clone());h.rotation.z=Math.PI/2,h.position.set(.6*t,.05*t,0),e.add(h);for(let u=0;u<3;u++){const w=new p(new y(.26*t,.025*t,.3*t),new g({color:17578,roughness:.8}));w.position.set(.6*t,(-.05+u*.06)*t,0),e.add(w)}return e.userData.trigger=c,e}_buildKnife(t=1){const e=new O,s=new g({color:5592422,roughness:.72}),o=new g({color:2236979,roughness:.8}),i=new g({color:13421772,roughness:.18,metalness:.92});new g({color:1118481,roughness:.6});const a=new p(new y(.88*t,.22*t,.2*t),s.clone());a.position.set(-.18*t,0,0),e.add(a);for(let w=0;w<5;w++){const b=new p(new y(.025*t,.225*t,.21*t),new g({color:3355460,roughness:.85}));b.position.set((-.48+w*.13)*t,0,0),e.add(b)}const n=new p(new y(.28*t,.2*t,.22*t),o.clone());n.position.set(.44*t,.01*t,0),e.add(n);const r=new p(new y(.56*t,.048*t,.018*t),i.clone());r.position.set(.48*t,.09*t,0),e.add(r);const l=new We,c=new Float32Array([0,0,0,.14*t,0,0,.14*t,-.04*t,0,0,0,.018*t,.14*t,0,.018*t,.14*t,-.04*t,.018*t]);l.setAttribute("position",new $e(c,3)),l.setIndex([0,1,2,3,5,4,0,3,1,1,3,4,1,4,2,2,4,5]),l.computeVertexNormals();const d=new p(l,i.clone());d.position.set(.76*t,.09*t,0),e.add(d);const h=new p(new y(.12*t,.1*t,.22*t),o.clone());h.position.set(-.12*t,.16*t,0),e.add(h);const u=new p(new y(.035*t,.72*t,.035*t),i.clone());return u.position.set(-.18*t,0,.12*t),e.add(u),e.userData.blade=r,e}_buildRotary(t=1){const e=new O,s=new g({color:16755200,roughness:.6}),o=new g({color:6710903,roughness:.42,metalness:.5}),i=new g({color:12303308,roughness:.18,metalness:.9}),a=new g({color:1118481,roughness:.6}),n=new g({color:3355460,roughness:.7}),r=new p(new T(.095*t,.1*t,.85*t,18),s.clone());r.position.set(0,-.525*t,0),e.add(r);for(let w=0;w<4;w++){const b=new p(new $(.1*t,.01*t,6,18),n.clone());b.position.set(0,(-.25-w*.16)*t,0),b.rotation.x=Math.PI/2,e.add(b)}const l=new p(new T(.125*t,.125*t,.14*t,18),o.clone());l.position.set(0,-.045*t,0),e.add(l);const c=new p(new T(.175*t,.175*t,.4*t,20),o.clone());c.position.set(0,.255*t,0),e.add(c);const d=new p(new $(.115*t,.018*t,7,22),i.clone());d.position.set(0,.32*t,0),d.rotation.x=Math.PI/2,e.add(d);const h=new p(new T(.175*t,.175*t,.06*t,20),n.clone());h.position.set(0,.485*t,0),e.add(h);const u=new p(new T(.06*t,.06*t,.1*t,14),a.clone());u.position.set(0,.5*t,0),e.add(u);for(let w=0;w<8;w++){const b=w/8*Math.PI*2,_=new p(new y(.025*t,.35*t,.025*t),n.clone());_.position.set(Math.cos(b)*.175*t,.255*t,Math.sin(b)*.175*t),e.add(_)}return e}_buildStrippedWire(t=.55,e={}){const s=new O,o=new g({color:e.insColor||1710638,roughness:.35,metalness:.05,clearcoat:.8,clearcoatRoughness:.2}),i=new g({color:13928762,roughness:.15,metalness:.95,emissive:e.glowCopper?new A(13928762):new A(0),emissiveIntensity:e.glowCopper?.4:0}),a=e.insLen||2.8,n=new p(new T(.13,.13,a,24),o);n.rotation.z=Math.PI/2,n.position.x=-(a/2+t/2),s.add(n);const r=new p(new T(.065,.13,.08,24),o);r.rotation.z=Math.PI/2,r.position.x=-(t/2)-.04,s.add(r);const l=new p(new T(.065,.065,t,20),i);l.rotation.z=Math.PI/2,s.add(l);for(let c=0;c<7;c++){const d=c/7*Math.PI*2,h=new p(new T(.015,.015,t,8),i);h.rotation.z=Math.PI/2,h.position.set(0,Math.cos(d)*.06,Math.sin(d)*.06),s.add(h)}return s.userData.copMesh=l,s.userData.copMat=i,s.userData.insMat=o,s}_applyScene(t){if(this._clearSceneObjs(),!this._three)return;const e=t.scene,s=(i,a,n=0)=>{i.position.set(a,-.38+n,.2),i.rotation.set(0,0,Math.PI/2),this._add(i)},o=(i,a,n=0)=>{i.position.set(a,-.38+n,.2),i.rotation.set(Math.PI/2,0,0),this._add(i)};if(e!=="bench_clean"){if(e==="bench_tools"){const i=this._buildManual(.55);this._tagMeshes(i,"manual"),s(i,-2.8);const a=this._buildAutomatic(.55);this._tagMeshes(a,"automatic"),s(a,-.9);const n=this._buildKnife(.55);this._tagMeshes(n,"knife"),s(n,.9);const r=this._buildRotary(.55);this._tagMeshes(r,"rotary"),o(r,2.8);return}if(e==="all_tools"){ue.forEach(i=>{let a;i.id==="manual"&&(a=this._buildManual(.68)),i.id==="automatic"&&(a=this._buildAutomatic(.68)),i.id==="knife"&&(a=this._buildKnife(.68)),i.id==="rotary"&&(a=this._buildRotary(.68)),this._tagMeshes(a,i.id),i.id==="rotary"?o(a,i.x,.12):s(a,i.x,.12);const n=Mt(i.hex,i.name);n.position.set(i.x,.42,.2),this._add(n),this._tsGroups.push(a)}),t.t==="tselect"&&(this._tsActive=!0,this._el.querySelector("#wsl-tap-hint").style.display="block");return}if(e==="show_manual"){const i=this._buildManual(1.1);i.position.set(0,0,0),i.rotation.set(.15,-.5,0),this._add(i);const a=this._el.querySelector("#wsl-tool-badge");this._el.querySelector("#wsl-badge-name").textContent="MANUAL STRIPPER",this._el.querySelector("#wsl-badge-tag").textContent="AWG NOTCH SELECTION",a.classList.add("show"),this._animScene="float",this._animObjs={pivot:i};return}if(e==="show_automatic"){const i=this._buildAutomatic(1.1);i.position.set(0,.1,0),i.rotation.set(.15,-.5,0),this._add(i);const a=this._el.querySelector("#wsl-tool-badge");this._el.querySelector("#wsl-badge-name").textContent="AUTOMATIC STRIPPER",this._el.querySelector("#wsl-badge-tag").textContent="SELF-ADJUSTING JAWS",a.classList.add("show"),this._animScene="float",this._animObjs={pivot:i};return}if(e==="show_knife"){const i=this._buildKnife(1.1);i.position.set(0,0,0),i.rotation.set(.15,-.5,0),this._add(i);const a=this._el.querySelector("#wsl-tool-badge");this._el.querySelector("#wsl-badge-name").textContent="UTILITY KNIFE",this._el.querySelector("#wsl-badge-tag").textContent="SCORE LENGTHWISE ONLY",a.classList.add("show"),this._animScene="float",this._animObjs={pivot:i};return}if(e==="show_rotary"){const i=this._buildRotary(1.1);i.position.set(0,0,0),i.rotation.set(.3,-.4,0),this._add(i);const a=this._el.querySelector("#wsl-tool-badge");this._el.querySelector("#wsl-badge-name").textContent="ROTARY STRIPPER",this._el.querySelector("#wsl-badge-tag").textContent="CIRCULAR BLADE — RING CUT",a.classList.add("show"),this._animScene="float",this._animObjs={pivot:i};return}if(e==="anim_manual"||e==="anim_automatic"||e==="anim_knife"||e==="anim_rotary"){const i=e.replace("anim_",""),a=new g({color:1710638,roughness:.65}),n=new p(new T(.13,.13,3.2,20),a);n.rotation.z=Math.PI/2,n.position.set(-1,-.35,0),n.castShadow=!0,this._add(n);const r=new g({color:1710638,roughness:.65,transparent:!0,opacity:1}),l=new p(new T(.132,.132,1.1,20),r);l.rotation.z=Math.PI/2,l.position.set(.9,-.35,0),this._add(l);const c=new g({color:12088115,roughness:.22,metalness:.85,emissive:new A(12088115),emissiveIntensity:0,transparent:!0,opacity:0}),d=new p(new T(.065,.065,1.1,16),c);d.rotation.z=Math.PI/2,d.position.set(.9,-.35,0),this._add(d);const h=new g({color:12088115,roughness:.22,metalness:.85}),u=new p(new T(.065,.065,.14,14),h);u.rotation.z=Math.PI/2,u.position.set(-2.67,-.35,0),this._add(u);let w;i==="manual"&&(w=this._buildManual(.9)),i==="automatic"&&(w=this._buildAutomatic(.9)),i==="knife"&&(w=this._buildKnife(.9)),i==="rotary"&&(w=this._buildRotary(.9)),i==="rotary"?(w.rotation.set(Math.PI/2,0,0),w.position.set(.9,1.8,0)):(w.rotation.set(0,0,Math.PI/2),w.position.set(.9,1.8,0)),this._add(w),this._animScene=`strip_${i}`,this._animT=0,this._animObjs={tool:w,sleeve:l,sleeveMat:r,copper:d,copMat:c,armA:w.userData.armA||null,armB:w.userData.armB||null};return}if(e==="bad_teeth"){const i=new g({color:1710638,roughness:.65}),a=new p(new T(.13,.13,5,20),i);a.rotation.z=Math.PI/2,a.position.set(0,-.35,0),a.castShadow=!0,this._add(a);const n=new g({color:4456448,roughness:.9}),r=new p(new T(.135,.135,.18,20),n);r.rotation.z=Math.PI/2,r.position.set(0,-.35,0),this._add(r);const l=new g({color:3346688,roughness:.95}),c=new p(new y(.24,.1,.2),l);c.position.set(0,-.35,0),this._add(c);const d=Mt("#ff4444","⚠ NEVER DO THIS");d.scale.set(1.1,.38,1),d.position.set(0,.28,0),this._add(d);return}if(e==="bad_crush"){const i=new g({color:2250171,roughness:.65}),a=new p(new T(.13,.13,4.8,20),i);a.rotation.z=Math.PI/2,a.position.set(0,-.35,0),a.castShadow=!0,this._add(a);const n=new g({color:1718920,roughness:.85}),r=new p(new T(.13,.08,.22,12),n);r.rotation.z=Math.PI/2,r.scale.y=.45,r.position.set(.3,-.35,0),this._add(r);const l=new g({color:14496512,roughness:.5,emissive:new A(4456448),emissiveIntensity:.5});for(let d=0;d<5;d++){const h=new p(new T(.008,.008,.28,6),l.clone());h.rotation.z=Math.PI/2,h.position.set(.3,-.35+(d-2)*.025,(d-2)*.018),this._add(h)}const c=Mt("#ff4444","⚠ WRONG NOTCH");c.scale.set(1.1,.38,1),c.position.set(0,.28,0),this._add(c);return}if(e==="bad_nick"){const i=new g({color:1710638,roughness:.65}),a=new p(new T(.13,.13,3.2,20),i);a.rotation.z=Math.PI/2,a.position.set(-.85,-.35,0),a.castShadow=!0,this._add(a);const n=new g({color:12088115,roughness:.22,metalness:.85}),r=new p(new T(.065,.065,1,16),n);r.rotation.z=Math.PI/2,r.position.set(.75,-.35,0),this._add(r);const l=new g({color:5570560,roughness:.9,emissive:new A(2228224),emissiveIntensity:.5}),c=new p(new $(.067,.02,6,16),l);c.rotation.y=Math.PI/2,c.position.set(.38,-.35,0),this._add(c);const d=new X(16720384,2,.5);d.position.set(.38,-.35,0),this._add(d);const h=Mt("#ff4444","⚠ NICKED COPPER");h.scale.set(1.1,.38,1),h.position.set(0,.28,0),this._add(h);return}if(e==="good_strip"){const i=new g({color:1710638,roughness:.65}),a=new p(new T(.13,.13,3.2,20),i);a.rotation.z=Math.PI/2,a.position.set(-.9,-.35,0),a.castShadow=!0,this._add(a);const n=new g({color:12088115,roughness:.22,metalness:.85,emissive:new A(4465152),emissiveIntensity:.35}),r=new p(new T(.065,.065,.72,16),n);r.rotation.z=Math.PI/2,r.position.set(.58,-.35,0),this._add(r);const l=new g({color:2999891,roughness:.5,emissive:new A(2999891),emissiveIntensity:.6}),c=new p(new $(.133,.012,8,20),l);c.rotation.y=Math.PI/2,c.position.set(.22,-.35,0),this._add(c);const d=new X(2999891,1.5,1.2);d.position.set(.58,-.2,0),this._add(d);const h=Mt("#2dc653","✓ CORRECT STRIP");h.scale.set(1.1,.38,1),h.position.set(0,.28,0),this._add(h);return}if(e==="quality_nick"){const i=this._buildStrippedWire(.65);i.position.set(.35,-.35,0),this._add(i);const a=new g({color:5570560,roughness:.9,emissive:new A(3342336),emissiveIntensity:.6}),n=new p(new $(.067,.022,6,16),a);n.rotation.y=Math.PI/2,n.position.set(.35,-.35,0),this._add(n);const r=new X(16720384,1.5,.7);r.position.set(.35,-.2,0),this._add(r);const l=this._el.querySelector("#wsl-quality-badge");l.textContent="FAIL ✗",l.className="wsl-quality-badge fail";return}if(e==="quality_long"){const i=this._buildStrippedWire(1.8,{insLen:1.6});i.position.set(.65,-.35,0),this._add(i);const a=new X(16729088,1.2,1.5);a.position.set(.65,-.25,0),this._add(a),this._animScene="quality_pulse_red",this._animObjs={mat:i.userData.copMat};const n=this._el.querySelector("#wsl-quality-badge");n.textContent="FAIL ✗",n.className="wsl-quality-badge fail";return}if(e==="quality_ragged"){const i=new g({color:1710638,roughness:.65}),a=new p(new T(.13,.13,2.8,20),i);a.rotation.z=Math.PI/2,a.position.set(-.65,-.35,0),this._add(a);const n=new g({color:12088115,roughness:.22,metalness:.85}),r=new p(new T(.065,.065,.65,16),n);r.rotation.z=Math.PI/2,r.position.set(.58,-.35,0),this._add(r);const l=new g({color:2763322,roughness:.9});[.1,-.08,.13,-.05,.09].forEach((u,w)=>{const b=new p(new y(.06,.1,.05),l.clone());b.position.set(.22,-.35+u,(w-2)*.04),b.rotation.z=u,this._add(b)});const d=Mt("#ff8800","⚠ RAGGED EDGE");d.scale.set(1,.36,1),d.position.set(0,.26,0),this._add(d);const h=this._el.querySelector("#wsl-quality-badge");h.textContent="FAIL ✗",h.className="wsl-quality-badge fail";return}if(e==="quality_good"){const i=this._buildStrippedWire(.7,{glowCopper:!0});i.position.set(.35,-.35,0),this._add(i);const a=new g({color:2999891,roughness:.5,emissive:new A(2999891),emissiveIntensity:.55}),n=new p(new $(.133,.012,8,20),a);n.rotation.y=Math.PI/2,n.position.set(.35,-.35,0),this._add(n);const r=new X(2999891,1.4,1.4);r.position.set(.35,-.22,.3),this._add(r);const l=this._el.querySelector("#wsl-quality-badge");l.textContent="PASS ✓",l.className="wsl-quality-badge pass",this._animScene="quality_pulse_green",this._animObjs={mat:i.userData.copMat};return}}}_updateThree(){if(!this._three)return;const{camera:t,lamp:e}=this._three,s=performance.now()*.001,o=Math.min(s-this._lastTime,.05);this._lastTime=s;const a=Q[this._step].cam;this._camPos.lerp(new m(...a.p),.044),this._camTarget.lerp(new m(...a.t),.044),t.position.copy(this._camPos),t.lookAt(this._camTarget),e.intensity=1.6+Math.sin(s*4)*.08;for(const n of this._dropObjs){const r=n.mesh.position.y-n.target;Math.abs(r)<.008&&Math.abs(n.vel)<.002?n.mesh.position.y=n.target:(n.vel+=-.018*r-.18*n.vel,n.mesh.position.y+=n.vel)}if(this._sparks=this._sparks.filter(n=>(n.life-=.025,n.life<=0?(this._three.scene.remove(n.mesh),!1):(n.vel.y-=.005,n.mesh.position.addScaledVector(n.vel,1),n.mesh.material.opacity=n.life,!0))),this._animScene==="float"){const n=this._animObjs.pivot;n&&(n.rotation.y=Math.sin(s*.55)*.35)}if(this._animScene&&this._animScene.startsWith("strip_")&&(this._animT=(this._animT+o*.22)%1,this._updateStripAnim(this._animT)),this._animScene==="quality_pulse_red"){const n=this._animObjs.mat;n&&(n.emissive=new A(16720384),n.emissiveIntensity=.3+Math.sin(s*3.5)*.25)}if(this._animScene==="quality_pulse_green"){const n=this._animObjs.mat;n&&(n.emissiveIntensity=.3+Math.sin(s*2)*.18)}for(const n of this._tsGroups)n&&(n.position.y=-.26+Math.sin(s*1.2+n.position.x*.8)*.025)}_updateStripAnim(t){const{tool:e,sleeve:s,sleeveMat:o,copper:i,copMat:a,armA:n,armB:r}=this._animObjs;if(!e)return;const l=this._animScene.replace("strip_","");if(t<.35){const c=zt(t/.35);e.position.y=Yt.lerp(1.8,.12,c),e.position.x=.9,o&&(o.opacity=1),a&&(a.opacity=0),n&&(n.rotation.z=.32),r&&(r.rotation.z=-.32)}else if(t<.52){const c=zt((t-.35)/.17);e.position.y=.12,n&&(n.rotation.z=Yt.lerp(.32,.055,c)),r&&(r.rotation.z=Yt.lerp(-.32,-.055,c)),l==="rotary"&&(e.rotation.z=c*Math.PI*2),l==="automatic"&&e.userData.trigger&&(e.userData.trigger.rotation.z=Yt.lerp(.18,.55,c))}else if(t<.82){const c=zt((t-.52)/.3),d=c*1.55;e.position.x=.9+d,e.position.y=.12,s&&(s.position.x=.9+d),o&&(o.opacity=1-zt(c)),a&&(a.opacity=zt(c)),l==="rotary"&&(e.rotation.z=Math.PI*2+c*Math.PI*4),l==="knife"&&e.rotation.set(0,0,Math.PI/2-.25)}else{const c=(t-.82)/.18;a&&(a.opacity=1,a.emissiveIntensity=.4+Math.sin(c*Math.PI*4)*.3),t>.96&&(e.position.set(.9,1.8,0),s&&(s.position.x=.9),n&&(n.rotation.z=.32),r&&(r.rotation.z=-.32),l==="rotary"?e.rotation.set(Math.PI/2,0,0):e.rotation.set(0,0,Math.PI/2),l==="automatic"&&e.userData.trigger&&(e.userData.trigger.rotation.z=.18),this._animT=0)}}_spawnSparks(t){if(this._three)for(let e=0;e<14;e++){const s=new J({color:[16763904,16746496,16777215][e%3],transparent:!0,opacity:1}),o=new p(new gt(.03,4,4),s);o.position.copy(t),this._three.scene.add(o),this._sparks.push({mesh:o,life:.65+Math.random()*.5,vel:new m((Math.random()-.5)*.09,.05+Math.random()*.09,(Math.random()-.5)*.09)})}}_showFeedback(t){const e=this._el.querySelector("#wsl-feedback");this._el.querySelector("#wsl-fb").textContent=t,e.classList.add("show"),setTimeout(()=>e.classList.remove("show"),820)}_onToolTap(t,e){var n,r;if(!this._tsActive||this._tsAnswered)return;const s=Q[this._step];if(s.t!=="tselect")return;const o=Le[s.qIdx].a;this._tsAnswered=!0,this._tsActive=!1,this._el.querySelector("#wsl-tap-hint").style.display="none";const i=this._el.querySelector(".wsl-ts-result");(n=ue.find(l=>l.id===t))!=null&&n.name||t.toUpperCase();const a=((r=ue.find(l=>l.id===o))==null?void 0:r.name)||o.toUpperCase();t===o?(this._showFeedback("✅"),this._spawnSparks(e),i&&(i.textContent=`✓ Correct! ${a} is the right choice.`,i.className="wsl-ts-result ok")):(this._showFeedback("❌"),i&&(i.textContent=`✗ Incorrect. The right tool is the ${a}.`,i.className="wsl-ts-result fail")),setTimeout(()=>{this._el.querySelector("#wsl-next").disabled=!1},500)}_renderQuiz(t){const e=be[t],s=this._el.querySelector("#wsl-dialog"),o=Math.round(this._step/(Q.length-1)*100);s.innerHTML=`
      ...
      <div class="wsl-progress-row">
        ...
        <div class="wsl-progress-row">
          <div class="wsl-prog-bar"><div class="wsl-prog-fill" id="wsl-prog"></div></div>
          <span class="wsl-prog-pct" id="wsl-pct"></span>
        </div>`,this._el.querySelector("#wsl-bubble-tap").addEventListener("click",()=>this._onNext())),this._el.querySelector("#wsl-text").textContent=t.text||"",this._el.querySelector("#wsl-prog").style.width=s+"%",this._el.querySelector("#wsl-pct").textContent=s+"%",i.disabled=!1,i.textContent=t.btn||"NEXT →",this._el.querySelector("#wsl-bubble-tap").style.display=t.btn?"none":"block";const n=this._el.querySelector("#wsl-avatar");n&&(t.mascotIn?(n.classList.remove("entered"),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("entered")))):n.classList.add("entered"))}_gotoStep(t){this._step=Math.max(0,Math.min(Q.length-1,t));const e=Q[this._step];this._applyScene(e),this._render()}_onNext(){if(Q[this._step].t==="done"){const e=L.getLearnStage("wireStripping");L.completeLesson("wireStripping"),L.saveLearnStage("wireStripping"),e||L.addXP(100),this.state.setState("stagesHub");return}this._step<Q.length-1&&this._gotoStep(this._step+1)}_onPrev(){this._step>0&&this._gotoStep(this._step-1)}onShow(){this._step=0,this._animT=0,this._sparks=[],this._camPos.set(0,2.5,7.5),this._camTarget.set(0,-.3,0),this._render(),setTimeout(()=>{if(this._initThree(),this._three){const t=Q[this._step];this._applyScene(t)}else setTimeout(()=>{this._applyScene(Q[this._step])},200)},80)}onHide(){this._animId&&(cancelAnimationFrame(this._animId),this._animId=null),this._resizeObs&&(this._resizeObs.disconnect(),this._resizeObs=null),this._three&&(this._clearSceneObjs(),this._three.renderer.dispose(),this._three=null),this._sparks=[],this._animScene=null}}const Ct=[{key:"wireTypes",state:"wireTypes",num:"01",title:`UNDERSTAND
...
`;function Ls(){if(document.querySelector("#sh-css"))return;const f=document.createElement("style");f.id="sh-css",f.textContent=Cs,document.head.appendChild(f)}class Is{constructor(t){this.state=t,this.container=this._build()}_build(){Ls();const t=document.createElement("div");return t.className="screen screen-hidden",t.innerHTML=`
      ...
      </div>`,t.querySelector(".sh-back").addEventListener("click",()=>this.state.setState("menu")),this._el=t,t}_render(){const t=Ct.filter(d=>L.getLearnStage(d.key)).length,e=Ct.length,s=Math.round(t/e*100),o=Ct.findIndex(d=>!L.getLearnStage(d.key));this._el.querySelector("#sh-pct").textContent=s+"%",this._el.querySelector("#sh-pct2").textContent=s+"%";const i=2*Math.PI*23;this._el.querySelector("#sh-circ").style.strokeDashoffset=i-s/100*i;const a=["Just Started","Keep Going!","Good Progress","Half Way!","Almost Done!","Almost Done!","Complete! 🎉"];this._el.querySelector("#sh-head").textContent=a[t]||"Complete!",this._el.querySelector("#sh-sub").textContent=t===e?"All stages complete!":`${t} of ${e} done`;const n=this._el.querySelector("#sh-scroll");let r="";Ct.forEach((d,h)=>{const u=L.getLearnStage(d.key),w=L.isLearnStageUnlocked(d.key),b=h===o&&w,_=!w,v=u?"sh-b-done":b?"sh-b-prog":w?"sh-b-avail":"sh-b-lock",S=u?"COMPLETED":b?"IN PROGRESS":w?"AVAILABLE":"LOCKED",E=`sh-card ${u?"sh-done":b?"sh-active":_?"sh-locked":""}`,z=u?"sh-btn-done":b?"sh-btn-cont":w?"sh-btn-start":"sh-btn-lock",x=u?"✓  REVIEW":b?"CONTINUE →":w?"START →":"🔒  LOCKED",k=d.title.split(`
`).join("<br>");r+=`
        <div class="${E}" data-state="${d.state}">
          <div class="sh-card-img">
            ...
            <div class="sh-badge ${v}">${S}</div>
            <span style="position:relative;z-index:3">${Ms(d.icon,d.color)}</span>
          </div>
          <div class="sh-card-body">
            <div class="sh-card-title">${k}</div>
            <div class="sh-card-desc">${d.desc}</div>
          </div>
          <button class="sh-card-btn ${z}" ${_?"disabled":""}>${x}</button>
        </div>`,h<Ct.length-1&&(r+=`<div class="sh-arrow">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
            <polyline points="9 18 15 12 9 6"/>
          </svg>
        </div>`)}),n.innerHTML=r,n.querySelectorAll(".sh-card:not(.sh-locked)").forEach(d=>{d.addEventListener("click",()=>{const h=d.dataset.state;h&&this.state.setState(h)})});let l="";Ct.forEach((d,h)=>{const u=L.getLearnStage(d.key),w=h===o&&L.isLearnStageUnlocked(d.key);L.isLearnStageUnlocked(d.key),l+=`
        <div class="sh-chk">
          <div class="sh-chk-dot ${u?"d-done":w?"d-active":"d-lock"}"></div>
          <div class="sh-chk-name ${u?"done":w?"active":""}">${d.num.replace(/^0/,"")}. ${d.short}</div>
...
`;function Os(){if(document.querySelector("#ol-css"))return;const f=document.createElement("style");f.id="ol-css",f.textContent=As,document.head.appendChild(f)}function ot(f,t,e,s,o=.7,i=.1){return new p(new y(f,t,e),new g({color:s,roughness:o,metalness:i}))}function Pt(f,t,e,s,o,i=.5,a=.3){return new p(new T(f,t,e,s),new g({color:o,roughness:i,metalness:a}))}function Lt(f){return f<.5?4*f*f*f:1-Math.pow(-2*f+2,3)/2}class Rs{constructor(t){le(this,"_$",t=>this._el.querySelector(`#${t}`));this.state=t,this._animId=null,this._renderer=null,this._timerIv=null,this.container=this._build()}_build(){Os();const t=document.createElement("div");return t.className="screen screen-hidden",t.innerHTML=`
      <div class="ol">
...
`;let Ie=!1;function Ps(){if(Ie)return;Ie=!0;const f=document.createElement("style");f.id="hls-css",f.textContent=zs,document.head.appendChild(f)}class fe{constructor(t,e){this.state=t,this.cfg=e,this.container=this._build()}_build(){Ps();const t=document.createElement("div");t.className="screen screen-hidden",t.innerHTML=`
      <div class="hls">
...
`;class Gs{constructor(t){this._root=t,this._tipEl=null,this._tipTimer=null,this._tutEl=null,this._shown=null,this._isMob=navigator.maxTouchPoints>0,this._injectCSS()}_injectCSS(){if(document.querySelector("#mg-css"))return;const t=document.createElement("style");t.id="mg-css",t.textContent=js,document.head.appendChild(t)}showTutorial(t){if(this._tutEl)return;let e=0;const s=Ds,o=s.length,i=document.createElement("div");i.className="mg-tutorial";const a=Array.from({length:o},(b,_)=>`<div class="mg-dot${_===0?" active":""}"></div>`).join("");i.innerHTML=`
    ...
    `;const n=i.querySelector(".mg-next-btn"),r=i.querySelector(".mg-skip-btn"),l=i.querySelector(".mg-step-title"),c=i.querySelector(".mg-step-text"),d=i.querySelector(".mg-step-counter"),h=i.querySelectorAll(".mg-dot"),u=()=>{const b=s[e];d.textContent=`Step ${e+1} of ${o}`,l.textContent=b.title,c.innerHTML=b.text||(this._isMob?b.textMobile:b.textDesktop)||"",h.forEach((_,v)=>_.classList.toggle("active",v===e)),n.textContent=e===o-1?"Let's Go ⚡":"Next →"},w=()=>{i.classList.add("hiding"),setTimeout(()=>{i.remove(),this._tutEl=null},260),t==null||t()};n.addEventListener("click",()=>{e<o-1?(e++,u()):w()}),r.addEventListener("click",w),u(),this._root.appendChild(i),this._tutEl=i}show(t){const e=Fs[t];if(!e||this._shown===t)return;clearTimeout(this._tipTimer),this._tipEl&&(this._tipEl.remove(),this._tipEl=null),this._shown=t;const s=document.createElement("div");s.className="mg-tip",s.innerHTML=`
...
`;function Xs(){if(document.querySelector("#ex-css"))return;const f=document.createElement("style");f.id="ex-css",f.textContent=Ys,document.head.appendChild(f)}class Vs{constructor(t){this.state=t,this._scene=null,this.container=this._build()}_build(){Xs();const t=navigator.maxTouchPoints>0,e=document.createElement("div");e.className="screen screen-hidden",e.innerHTML=`
      ...
      <div class="hud-top">
        ...
        <button class="hud-btn" id="hud-pause">${F.pause}</button>
      </div>
      <div class="hud-task">
    ...
    `,document.getElementById("ui-root").appendChild(this._hud),this._hud.querySelector("#hud-menu").addEventListener("click",()=>{this.state.setState("menu")})}update(t){this._active&&(this._t+=t,this._lampFill&&(this._lampFill.intensity=.65+Math.sin(this._t*3.1)*.04),this.renderer.instance.render(this._scene,this._camera))}_onResize(){this._camera&&(this._camera.aspect=window.innerWidth/window.innerHeight,this._camera.updateProjectionMatrix())}}class Zs{constructor(){this.state=new Xe,this.loop=new Ve,this.renderer=new Ue,this.input=new Ke,this.ui=new Ks(this.state),this.scene=new Qs(this.renderer,this.loop,this.state),this.db=L}init(){this.renderer.init(),this.input.init(),this.ui.init(),this.scene.init(),this.state.on("stateChange",({from:t,to:e})=>{e==="game"?(this.renderer.show(),this.loop.start()):t==="game"&&(this.renderer.hide(),this.loop.stop())}),this.loop.add(t=>this.scene.update(t)),this.state.setState("splash")}}V.init();const Js=new Zs;Js.init();
