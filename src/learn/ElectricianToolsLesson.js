...
const STEPS = [
  ...
  { t:'info', scene:'bench_clean',
    ...
    text:"Meet the 12 tools every electrician uses! Learn what each one does, how to use it, and how to stay safe.", btn:'START →' },
  ...
  { t:'chap', scene:'cutting_group', ch:1, chLbl:'CH.1 CUTTING', title:'CUTTING TOOLS',
    text:'Three cutting tools — each for a different job. Always use the right one!' },
  { t:'tool', scene:'show_lineman', chLbl:'CH.1 CUTTING', toolName:"LINEMAN'S PLIERS",
    about:"The main tool for PH electrical work. Twists wires together, cuts thick conductors, and pulls wire through conduit.",
    features:[['✂','Cuts AWG 8–12'],['⟳','Wire Twisting'],['🛡','VDE 1000V']],
    howTo:['Grip the wire in the serrated jaw.','Twist both handles to join wires.','Use the notch near the pivot to cut thick wire.'],
    tip:'Always twist clockwise — it makes a tighter, stronger splice.' },
  { t:'tool', scene:'show_dykes', chLbl:'CH.1 CUTTING', toolName:'DIAGONAL CUTTERS',
    about:"Angled jaws cut flush to the surface — great for clean, close cuts at terminals.",
    features:[['→','Flush Cut'],['🎯','Tight Spaces'],['✂','AWG 14–22']],
    howTo:['Place the angled jaw flat against the surface.','Squeeze to shear the wire.','Cut zip ties at the base for a clean finish.'],
    tip:'Cleaner cut than straight jaws — less fraying, less risk of a hot spot.' },
  { t:'tool', scene:'show_knife', chLbl:'CH.1 CUTTING', toolName:'UTILITY KNIFE',
    about:"Scores the outer cable jacket only — never the wires inside. Always cut lengthwise, never in a ring.",
    features:[['|','Score Only'],['↩','Retractable'],['⚠','Away From Body']],
    howTo:['Extend the blade carefully.','Score along the jacket lengthwise — not in a circle.','Bend the cable to open the cut and peel the jacket off.'],
    tip:'Never cut in a ring — it will nick the wires underneath!' },

  // ── Ch2 Gripping ───────────────────────────────────────────
  { t:'chap', scene:'gripping_group', ch:2, chLbl:'CH.2 GRIPPING', title:'GRIPPING TOOLS',
    text:'Two tools: one for detail work, one for bending conduit.' },
  { t:'tool', scene:'show_longnose', chLbl:'CH.2 GRIPPING', toolName:'LONG NOSE PLIERS',
    about:"Narrow jaws reach into tight spots. Great for bending wire ends and positioning wires inside boxes.",
    features:[['↔','Tight Reach'],['⌒','Hook Bending'],['◆','Precise Grip']],
    howTo:['Hold the wire tip with the narrow jaws.','Bend gently to the angle you need.','Make a J-hook shape for screw terminals.'],
    tip:'Move gently — forcing it can crush soft copper wire.' },
  { t:'tool', scene:'show_conduitbender', chLbl:'CH.2 GRIPPING', toolName:'CONDUIT BENDER',
    about:"Bends rigid conduit to exact angles. The angle marks and foot step help you bend without kinking.",
    features:[['📐','Angle Marks'],['⚙','No Kinks'],['⬇','Foot Step']],
    howTo:['Hook the head onto the conduit at the bend mark.','Press down on the foot step steadily.','Stop exactly at the angle marker you need.'],
    tip:'Never bend by hand — a kink blocks wires from passing through forever.' },

  // ── Ch3 Fastening ──────────────────────────────────────────
  { t:'chap', scene:'fastening_group', ch:3, chLbl:'CH.3 FASTENING', title:'FASTENING TOOLS',
    text:'Use the right screwdriver tip — wrong tips damage screws and can be dangerous.' },
  { t:'tool', scene:'show_flathead', chLbl:'CH.3 FASTENING', toolName:'FLATHEAD SCREWDRIVER',
    about:"Fits slotted screws on outlets, switches, and breakers. The tip must match the slot exactly — too narrow and it slips.",
    features:[['—','Slotted Tip'],['⚡','Panel Ready'],['🛡','VDE Handle']],
    howTo:['Match the tip width to the slot.','Press down firmly while turning.','Snug tight only — overtightening cracks the terminal.'],
    tip:'A slipping tip can cause arc flash — always match it before turning!' },
  { t:'tool', scene:'show_phillips', chLbl:'CH.3 FASTENING', toolName:'PHILLIPS SCREWDRIVER',
    about:"Cross tip for Phillips screws on boxes and cover plates. It self-centers — safer near live parts.",
    features:[['✚','Cross Tip'],['🎯','Self-Centers'],['📦','Box Mount']],
    howTo:['Place the tip on the screw — it seats itself.','Press down and turn.','Match the tip size (#1, #2, #3) to the screw.'],
    tip:'If the tip feels loose, switch sizes — a stripped head is very hard to remove.' },

  // ── Ch4 Testing & Measuring ────────────────────────────────
  { t:'chap', scene:'testing_group', ch:4, chLbl:'CH.4 TESTING', title:'TESTING & MEASURING',
    text:'Use these before touching any wire — they keep you safe.' },
  { t:'tool', scene:'show_tester', chLbl:'CH.4 TESTING', toolName:'VOLTAGE TESTER',
    about:"Detects live voltage without touching bare wire. Beeps and lights up the moment it senses power. The most important safety tool you own.",
    features:[['🔴','NCV Sensor'],['🔔','Beep Alert'],['🛡','No Contact']],
    howTo:['Hold the tip near the wire — no touching needed.','Beep + red light = live wire — do not touch!','Test every wire, even after the breaker is off.'],
    tip:'Test on a live outlet first — a dead tester gives no warning at all.' },
  { t:'tool', scene:'show_multimeter', chLbl:'CH.4 TESTING', toolName:'MULTIMETER',
    about:"Measures voltage, continuity, and resistance. Use it to check outlets, test for unbroken wires, and find loose connections.",
    features:[['V','Voltage'],['~','Continuity'],['Ω','Resistance']],
    howTo:['Turn the dial to the right mode (V, Ω, or continuity).','BLACK probe to COM, RED to measurement port.','Beep in continuity mode = wire is unbroken!'],
    tip:'Always connect the BLACK probe first — it avoids a short on first touch.' },
  { t:'tool', scene:'show_fishtape', chLbl:'CH.4 TESTING', toolName:'FISH TAPE',
    about:"Flexible steel tape on a reel. Push it through conduit first, hook your wire to the end, then pull it back through.",
    features:[['🌀','Reel Feed'],['↩','Hook End'],['💧','Lube Compatible']],
    howTo:['Feed the tape into the conduit and push it through.','Hook your wire to the end at the far opening.','Wind the reel to pull the wire back through.'],
    tip:'Use lubricant on runs over 5m — it stops the wire jacket from overheating.' },
  { t:'tool', scene:'show_measuringtape', chLbl:'CH.4 TESTING', toolName:'MEASURING TAPE',
    about:"Measure conduit runs and cut wire to length. Always add 15–20% extra — short wire inside a wall can't be fixed.",
    features:[['📏','Accurate'],['📌','Box Locate'],['➕','Add 15–20%']],
    howTo:['Extend and lock the blade at your measurement.','Mark your cut point on the wire or conduit.','Add 15–20% extra for bends and tails.'],
    tip:'Add length for every bend — short wire in conduit can never be extended.' },

  // ── Ch5 Protection ─────────────────────────────────────────
  { t:'chap', scene:'show_tape', ch:5, chLbl:'CH.5 PROTECTION', title:'ELECTRICAL TAPE',
    text:'Covers exposed wire — used in almost every connection.' },
  { t:'tool', scene:'show_tape', chLbl:'CH.5 PROTECTION', toolName:'ELECTRICAL TAPE',
    about:"Vinyl tape rated 600V. Stretchy enough to wrap tightly with no gaps — overlap each layer by half.",
    features:[['⚡','600V Rated'],['🌡','80°C Max'],['🔄','Self-Sealing']],
    howTo:['Stretch it as you wrap — tension seals it tight.','Overlap each wrap by half the width.','Extend 10mm past the bare copper on each side.'],
    tip:'Tape is not a connector — always use wire nuts first, then tape over.' },

  // ── Ch6 Safety ─────────────────────────────────────────────
  { t:'chap', scene:'all_tools', ch:6, chLbl:'CH.6 SAFETY', title:'TOOL SAFETY',
    text:'Four rules — follow them every single time.' },
  { t:'info', scene:'all_tools',
    chLbl:'CH.6 SAFETY', title:'RULES FOR SAFE TOOL USE',
    text:"1. INSPECT — Check handles and jaws before every job.\n2. RIGHT TOOL — Never use pliers as a hammer.\n3. VDE RATED — All handles must be VDE 1000V rated.\n4. STORE PROPERLY — Keep tools separate — nicked jaws cause hot spots.", btn:'START QUIZ →' },
  ...
  { t:'done', scene:'all_tools', cam:{p:[0,5,13],t:[0,0,0]},
    ...
    text:"You know your tools! 12 tools down — their purpose and the rules that keep you safe.\n\nNext: Wire Stripping — time to put them to work!", btn:'FINISH' },
];
